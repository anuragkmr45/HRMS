...
type SwaggerTransformObjectInput = Parameters<
  NonNullable<FastifyDynamicSwaggerOptions["transformObject"]>
>[0];
const enumValues = (values: readonly string[]): string[] => [...values];
const lowerHex64Example =
  "0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef";

const uuid = (
  description: string,
  example = "018f9f4a-7f9a-7c15-8f25-6f7f96f9f001",
): JsonSchema => ({
  type: "string",
  format: "uuid",
  description,
...
const deviceIdParamSchema = {
  ...
  required: ["deviceId"],
  properties: {
    deviceId: uuid("Registered device UUID path parameter"),
  },
};
...
const expenseDocumentParamSchema = {
  ...
  properties: {
    ...
    documentId: uuid(
      "Expense document or document metadata UUID path parameter",
    ),
  },
};
...
const paginationQuerySchema = {
  ...
  properties: {
    ...
    sort: {
      type: "string",
      maxLength: 64,
      description: "Optional sort key supported by the endpoint.",
    },
  },
};
...
const expectedVersionBodySchema = {
  ...
  properties: {
    expected_version: {
      ...
      minimum: 1,
      description:
        "Optimistic concurrency version from the latest aggregate read.",
      example: 3,
    },
  },
};
...
const idempotencyKeyHeaderObject = {
  ...
  properties: {
    "idempotency-key": {
      ...
      description:
        "Required client_event_id UUID. Reuse only to retry the same validated attendance punch request; a new logical action requires a new UUID.",
    },
  },
};
const idempotencyReplayResponseHeader = {
  description:
    "Present with value `true` only when the business response is replayed from a stored idempotency result or durable client_event_id command. The current HTTP response keeps the current x-request-id; replay is semantic business-response replay, not byte-for-byte transport-envelope replay.",
...
const errorResponseSchema = {
  ...
  properties: {
    ...
    details: {
      ...
      description:
        "Optional structured error details, including Zod formErrors/fieldErrors for validation failures.",
    },
    request_id: {
      type: "string",
      example: "601fe7b7-6361-463e-ae66-5d972673dd27",
    },
  },
...
const conflictResponseSchema = {
  ...
  properties: {
    ...
    message: {
      type: "string",
      example: "The ticket was modified by another actor. Refresh and retry.",
    },
  },
};
...
const authDevOnlySchema = {
  ...
  nullable: true,
  description:
    "Local/QA only token echo for automated testing. Production responses omit this object.",
  additionalProperties: true,
};
...
const signupBodySchema = {
  ...
  properties: {
    ...
    full_name: {
      ...
      minLength: 2,
      maxLength: 160,
      example: "Asha Founder",
    },
    email: {
      type: "string",
      format: "email",
      example: "asha.founder@example.test",
    },
    password: {
      type: "string",
      format: "password",
      ...
      maxLength: 128,
      description:
        "Optional. If omitted, verify-email returns a password setup token/action.",
    },
    timezone: {
      type: "string",
    ...
    invite_token: {
      type: "string",
      description: "Reserved for invited employee onboarding.",
      example: "invite-token-from-email",
    },
  },
  additionalProperties: false,
};
...
const verifyEmailBodySchema = {
  ...
  properties: {
    token: {
      ...
      minLength: 16,
      description:
        "Email verification token from backend-delivered email link.",
    },
    email: {
      type: "string",
      format: "email",
      description: "Optional UX correlation check.",
      example: "asha.founder@example.test",
    },
  },
  additionalProperties: false,
...
const verifyEmailResponseSchema = {
  ...
  properties: {
    ...
    next_step: {
      type: "string",
      enum: ["login", "set_password", "company_bootstrap"],
      example: "company_bootstrap",
    },
    dev_only: authDevOnlySchema,
  },
  additionalProperties: true,
...
const passwordSetBodySchema = {
  ...
  properties: {
    token: {
      type: "string",
      minLength: 16,
      description: "Password setup/reset token from email.",
    },
    password: {
      type: "string",
      format: "password",
...
const companyBootstrapBodySchema = {
  ...
  properties: {
    bootstrap_token: {
      ...
      minLength: 16,
      description:
        "One-time company bootstrap token issued after email verification.",
    },
    company_profile: {
      type: "object",
      properties: {
...
const companyLogoUploadBodySchema = {
  ...
  properties: {
    bootstrap_token: {
      ...
      minLength: 16,
      description:
        "Active company bootstrap token issued after email verification.",
    },
    file: {
      type: "string",
      format: "binary",
      description:
        "Company logo image. Backend media upload policy controls type, compression, and size.",
    },
  },
  additionalProperties: false,
};
...
const adminCompanyLogoUploadBodySchema = {
  ...
  properties: {
    file: {
      ...
      format: "binary",
      description:
        "Company logo image. Backend company-logo policy controls type, compression dimensions, and size.",
    },
  },
  additionalProperties: false,
};
...
const companyBootstrapResponseSchema = {
  ...
  properties: {
    ...
    next_steps: {
      type: "array",
      items: { type: "string" },
      example: ["login", "configure_core_master_data"],
    },
...
const sessionPreferenceBodySchema = {
  ...
  properties: {
    active_role_id: {
      type: "string",
      description: "Role key/label assigned to the current user.",
      example: "Admin",
    },
    active_role: {
      type: "string",
      description: "Alias for active_role_id.",
...
const authUserSchema = {
  ...
  properties: {
    ...
    email_verification_status: {
      type: "string",
      enum: ["unverified", "pending", "verified", "bounced", "blocked"],
      example: "verified",
    },
    timezone: { type: "string", example: "Asia/Kolkata" },
    roles: {
...
const authSessionContextSchema = {
  ...
  properties: {
    ...
    permissions: {
      type: "array",
      items: { type: "string" },
      example: ["expense:finance", "report:read"],
    },
...
const platformRegisteredDeviceSchema = {
  ...
  properties: {
    ...
    status: {
      type: "string",
      enum: ["registered", "suspended", "revoked"],
      example: "registered",
    },
...
const platformDeviceRegistrationBodySchema = {
  ...
  properties: {
    installation_id_hash: {
      ...
      maxLength: 64,
      description:
        "Lowercase SHA-256 hash of the app-generated installation identifier. Raw installation identifiers and device secrets are never accepted.",
...
const adminCompanyProfileSchema = {
  ...
  properties: {
    ...
    logo_url: {
      ...
      nullable: true,
      example:
        "https://res.cloudinary.com/example/image/upload/hawkaii-hrms/company-logo.jpg",
    },
    logoUrl: {
      type: "string",
      nullable: true,
    ...
    bootstrap_completed_at: {
      ...dateTime("Bootstrap completion timestamp"),
      nullable: true,
    },
...
const adminCompanyProfileUpdateBody = {
  ...
  properties: {
    company_name: {
      ...
      minLength: 2,
      maxLength: 160,
      example: "Hawkaii HRMS India",
    },
    website: {
      type: "string",
      nullable: true,
      maxLength: 240,
      example: "https://hawkaii.com",
    },
    industry: {
      type: "string",
      nullable: true,
...
const adminMasterDataQuerySchema = {
  ...
  properties: {
    ...
    active_only: {
      type: "boolean",
      description: "When true, return only active rows.",
      example: true,
    },
    search: {
      type: "string",
...
const adminExtendedMasterDataSchema = {
  ...
  properties: {
    ...
    description: {
      type: "string",
      nullable: true,
      example: "Regular employment type",
    },
    status: { type: "string", enum: ["active", "inactive"], example: "active" },
    active: { type: "boolean", example: true },
...
const adminRbacRoleSchema = {
  ...
  properties: {
    ...
    permission_ids: {
      type: "array",
      items: { type: "string", example: "employees:view" },
    },
    permissions: {
      type: "array",
      items: { type: "string", example: "employees:view" },
...
const adminRbacPermissionSchema = {
  ...
  properties: {
    ...
    description: {
      type: "string",
      example: "Allows view access for Employees.",
    },
  },
  additionalProperties: false,
};
...
const adminWorkflowStageSchema = {
  ...
  properties: {
    ...
    approver_type: {
      type: "string",
      enum: ["Reporting Manager", "Role", "Specific User"],
      example: "Reporting Manager",
    },
    approverType: {
      type: "string",
      enum: ["Reporting Manager", "Role", "Specific User"],
...
const adminEmailTemplateSchema = {
  ...
  properties: {
    ...
    subject: {
      type: "string",
      example: "Welcome to {{company}} - set up your account",
    },
    body: {
      type: "string",
      example:
...
const adminNotificationChannelSchema = {
  ...
  properties: {
    ...
    event_key: {
      type: "string",
      enum: [...adminNotificationEventKeys],
...
const adminNotificationChannelsUpdateBody = {
  ...
  properties: {
    channels: {
      ...
      minItems: 1,
      maxItems: 8,
      items: adminNotificationChannelInputSchema,
    },
    expected_version: { type: "integer", minimum: 1, example: 1 },
  },
  additionalProperties: false,
...
const coreUserListItemSchema = {
  ...
  properties: {
    ...
    login_state: {
      type: "string",
      enum: ["enabled", "disabled", "setup_pending"],
      example: "enabled",
    },
    role_labels: {
      type: "array",
    ...
    profile_photo_document_id: {
      ...uuid("Profile photo document UUID"),
      nullable: true,
    },
    profile_photo_url: {
      type: "string",
...
const coreUserDetailSchema = {
  ...
  required: [
    ...coreUserListItemSchema.required,
    "reporting_line",
    "role_assignments",
...
const coreUserCreateBodySchema = {
  ...
  properties: {
    ...
    email: {
      type: "string",
      format: "email",
      example: "new.employee@example.test",
    },
    full_name: {
      type: "string",
      minLength: 2,
    ...
    login_enabled: {
      type: "boolean",
      description:
        "When true, creates a password setup action instead of assigning a default password.",
      example: true,
    },
  },
  additionalProperties: false,
...
const coreUserUpdateBodySchema = {
  ...
  properties: {
    ...
    email: {
      type: "string",
      format: "email",
      example: "employee.changed@example.test",
    },
    full_name: {
      type: "string",
      minLength: 2,
      maxLength: 160,
      example: "Employee Changed",
    },
    department_id: uuid("Department UUID"),
    designation_id: uuid("Designation UUID"),
    manager_user_id: { ...uuid("Reporting manager user UUID"), nullable: true },
...
const coreProfilePhotoPolicySchema = {
  ...
  properties: {
    ...
    cloudinary_transformation: {
      type: "string",
      example: "c_fill,g_face,w_512,h_512,q_auto:eco,f_auto",
    },
  },
  additionalProperties: false,
};
...
const coreProfilePhotoUploadBodySchema = {
  ...
  properties: {
    file: {
      ...
      format: "binary",
      description:
        "JPEG, PNG, or WebP profile photo. The backend validates size and type from policy.",
    },
  },
  additionalProperties: true,
};
...
const coreUserStatusBodySchema = {
  ...
  properties: {
    ...
    status: {
      type: "string",
      enum: ["inactive", "terminated", "suspended"],
      example: "inactive",
    },
  },
  additionalProperties: false,
...
const coreUserRolesBodySchema = {
  ...
  properties: {
    roles: {
      ...
      items: coreRoleSchema,
      minItems: 1,
      example: ["Employee", "HR Manager"],
    },
    expected_version: { type: "integer", minimum: 1, example: 1 },
    remarks: {
      type: "string",
      maxLength: 1000,
      example: "Role change approved by HR",
    },
  },
  additionalProperties: false,
};
...
const coreUserAuditQuerySchema = {
  ...
  properties: {
    ...
    event_type: {
      type: "string",
      maxLength: 120,
      example: "core.user.roles_replaced",
    },
...
const coreUserImportBodySchema = {
  ...
  properties: {
    ...
    file_name: {
      ...
      minLength: 1,
      maxLength: 240,
      example: "employees-may-2026.csv",
    },
    dry_run: { type: "boolean", example: true },
    mapping: {
      type: "object",
      additionalProperties: { type: "string" },
      example: { email: "Email", employee_code: "Employee ID" },
    },
  },
  additionalProperties: false,
};
...
const coreUserExportBodySchema = {
  ...
  properties: {
    ...
    filters: {
      type: "object",
      additionalProperties: true,
      example: { department_id: "018f9f4a-7f9a-7c15-8f25-6f7f96f9001" },
    },
    columns: {
      type: "array",
      maxItems: 80,
      items: { type: "string", maxLength: 80 },
      example: ["employee_code", "full_name", "email", "roles"],
    },
  },
  additionalProperties: false,
};
...
const coreUserImportJobSchema = {
  ...
  properties: {
    ...
    file: {
      ...
      properties: {
        document_id: {
          ...uuid("Uploaded import document UUID"),
          nullable: true,
        },
        file_name: {
          type: "string",
...
const coreUserExportJobSchema = {
  ...
  properties: {
    ...
    download_document_id: {
      ...uuid("Document UUID once generated"),
      nullable: true,
    },
...
const subtreeUserSchema = {
  ...
  properties: {
    ...
    depth: {
      ...
      minimum: 1,
      description:
        "Relative hierarchy depth below the requested root. Direct reports are depth 1.",
      example: 1,
    },
  },
};
...
const subtreeResponseSchema = {
  ...
  properties: {
    ...
    total_active_descendants: {
      ...
      minimum: 0,
      description:
        "Total active, non-deleted descendants under the requested root.",
      example: 3,
    },
    max_depth: {
      type: "integer",
      minimum: 0,
      description:
        "Deepest relative level returned in the full active subtree.",
      example: 1,
    },
    summary: {
      type: "object",
...
const ticketSchema = {
  ...
  properties: {
    ...
    requester_role_snapshot: {
      type: "string",
      example: "Employee / Software Engineer",
    },
    department_id: uuid("Department UUID"),
    expense_type: {
      type: "string",
      enum: ["Project", "SalesPreSales"],
      example: "Project",
    },
    expense_sub_type: {
      type: "string",
    ...
    payment_type: {
      type: "string",
      enum: ["Advance", "ReimbursementAccrued"],
      example: "Advance",
    },
    ...
    assigned_finance_actor_user_id: {
      ...uuid("Assigned finance-stage actor UUID"),
      nullable: true,
    },
    manager_verifier_id: {
      ...uuid("Assigned manager verifier UUID"),
      nullable: true,
    },
    manager_verifier_label: {
      type: "string",
      nullable: true,
      example: "D1 - Manager D1",
    },
    finance_approver_id: {
      ...uuid("Assigned finance approver UUID"),
      nullable: true,
    },
    finance_approver_label: {
      type: "string",
      nullable: true,
      example: "N1 - Finance Manager N1",
    },
    assigned_finance_actor_label: {
      type: "string",
      nullable: true,
      example: "N1 - Finance Manager N1",
    },
    primary_finance_manager_user_id: {
      ...uuid("Configured primary finance manager UUID"),
      nullable: true,
    },
    primary_finance_manager_label: {
      type: "string",
      nullable: true,
      example: "N1 - Finance Manager N1",
    },
    finance_approval_backup_user_id: {
      ...uuid("Configured fallback finance approver UUID"),
      nullable: true,
    },
    finance_backup_applied: {
      type: "boolean",
      description:
        "True when the requester is the configured primary finance manager and the finance stage is assigned to the configured backup.",
      example: false,
    },
    governance_warning_codes: {
      ...
      items: { type: "string" },
      description:
        "Route/governance warning markers preserved from the ticket route snapshot.",
...
const expenseTimelineEventSchema = {
  ...
  properties: {
    ...
    stage: {
      type: "string",
      enum: ["requester", "manager", "finance", "documents", "closure"],
      example: "manager",
    },
    ...
    status_from: {
      type: "string",
      nullable: true,
      example: "Pending Manager Verification",
    },
...
const assetRequestSchema = {
  ...
  properties: {
    ...
    request_type: {
      type: "string",
      enum: ["new", "replacement", "repair", "return"],
      example: "new",
    },
    asset_type: { type: "string", example: "Laptop" },
...
const assetRequestDecisionBodySchema = {
  ...
  properties: {
    decision: {
      type: "string",
      enum: ["approved", "rejected", "returned", "fulfilled"],
      example: "approved",
    },
    remarks: {
      type: "string",
...
const assetMaintenanceSchema = {
  ...
  properties: {
    ...
    maintenance_type: {
      type: "string",
      enum: ["repair", "preventive", "warranty", "inspection", "other"],
      example: "repair",
    },
...
const assetVendorSchema = {
  ...
  properties: {
    ...
    contact_email: {
      type: "string",
      nullable: true,
      example: "support@lenovo.example.test",
    },
...
const assetVendorCreateBodySchema = {
  ...
  properties: {
    name: {
      ...
      minLength: 2,
      maxLength: 160,
      example: "Apple Enterprise",
    },
    contact_email: {
      type: "string",
      format: "email",
      nullable: true,
      example: "support@apple.example.test",
    },
    phone: { type: "string", nullable: true, example: "+91-00000-00000" },
    status: { type: "string", enum: ["active", "inactive"], example: "active" },
    metadata: { type: "object", additionalProperties: true },
...
const assetRecoveryTicketSchema = {
  ...
  properties: {
    ...
    settlement_status: {
      type: "string",
      enum: ["recovered", "deduction", "waived", "lost_damaged"],
      nullable: true,
      example: "recovered",
    },
    ...
    settlement_remarks: {
      type: "string",
      nullable: true,
      example: "Recovered during exit clearance.",
    },
  ...
  properties: {
    ...
    scope: {
      ...
      properties: {
        ...
        visibility: {
          type: "string",
          enum: ["all", "self_and_descendants"],
          example: "self_and_descendants",
        },
      },
      additionalProperties: false,
    },
    ...
    approvals: {
      type: "object",
      required: [
        "expense_manager_pending",
        "expense_finance_pending",
        "expense_total_pending",
        "timesheet_pending",
    ...
    workload: {
      ...
      required: [
        "work_segments_total",
        "submitted_hours_total",
        "timesheet_submissions_total",
        "timesheet_submissions_approved",
        "timesheet_submissions_returned",
      ],
      properties: {
      ...
      items: {
        ...
        properties: {
          ...
          notes: {
            type: "string",
            example:
              "Leave/WFH/holiday workflows are scheduled for Phase 3 and are not counted in this dashboard yet.",
          },
        },
        additionalProperties: false,
      },
...
const attendanceLocationCoordinateEvidenceSchema = {
  ...
  properties: {
    ...
    captured_at: dateTime(
      "One-shot browser capture timestamp from the employee action.",
    ),
    age_ms: { type: "integer", minimum: 0, example: 30000 },
    provider: {
      type: "string",
      enum: enumValues(AttendanceLocationProviderValues),
      example: "browser",
    },
    permission_state: {
      type: "string",
      enum: ["granted", "unknown"],
      default: "unknown",
      example: "granted",
    },
...
const attendanceLocationEvidenceSchema = {
  ...
  description:
    "One-shot location evidence captured at employee action time. Required for source=web_geo. Failure evidence must not include coordinates.",
  examples: [
    {
      latitude: 12.971599,
      longitude: 77.594566,
...
const attendanceGeoPolicySnapshotSchema = {
  ...
  properties: {
    ...
    selected_action: {
      type: "string",
      enum: enumValues(AttendanceGeoPolicyActionValues),
      example: "allow",
    },
    ...
    geofence_version_id: {
      ...uuid("Effective geofence version UUID"),
      nullable: true,
    },
    ...
    evaluation: {
      ...
      additionalProperties: true,
      description:
        "Privacy-safe geofence explanation. Coordinates and raw payloads are not returned.",
    },
  },
  additionalProperties: true,
  example: {
...
const attendanceBusinessErrorDetailsSchema = {
  ...
  properties: {
    reason_code: {
      ...
      nullable: true,
      description:
        "Stable attendance command or geo-policy reason code when the failure is a persisted business denial.",
    },
...
const attendancePunchCommandBody = {
  ...
  required: ["event_type"],
  description:
    "Employee manual-now punch command. Use source=web_geo only for a single browser geolocation result collected at click time; continuous tracking, polling and client-submitted geo decisions are not accepted.",
  properties: {
    event_type: {
      type: "string",
      enum: Object.values(AttendancePunchEventTypes),
      example: "check_in",
    },
    work_mode: {
      type: "string",
      enum: ["office", "remote", "wfh", "field"],
      default: "office",
      example: "office",
    },
    source: {
      type: "string",
      enum: enumValues(AttendancePublicPunchSourceChannels),
      default: "web",
      example: "web_geo",
    },
    metadata: {
      ...
      additionalProperties: true,
      description:
        "Client metadata. Browser geo clients must not submit trusted geo-policy or geofence outcomes here.",
    },
...
const attendanceCommandDeviceBody = {
  ...
  properties: {
    registered_device_id: uuid(
      "Canonical platform registered device UUID required for personal-mobile attendance sources.",
    ),
    device_id: {
      type: "string",
      minLength: 1,
      maxLength: 128,
      example: "browser-session-device",
    },
    platform: {
      type: "string",
...
const attendancePunchBody = {
  ...
  properties: {
    ...
    captured_at: dateTime(
      "Client capture timestamp for audit/transport metadata. Does not control attendance occurred_at.",
    ),
...
const attendanceHistoricalCorrectionBody = {
  ...
  properties: {
    event_type: {
      type: "string",
      enum: enumValues(AttendanceHistoricalCorrectionEventTypeValues),
      example: "check_in",
    },
    ...
    linked_regularization_request_id: uuid(
      "Linked regularization request UUID",
    ),
  },
  additionalProperties: false,
};
...
const attendanceGeofencePublishBody = {
  ...
  properties: {
    ...
    effectiveUntil: {
      ...dateTime("Exclusive effective end timestamp"),
      nullable: true,
    },
  },
  additionalProperties: false,
...
const attendanceDaySchema = {
  ...
  properties: {
    ...
    status: {
      ...
      description:
        "Legacy compatibility status derived from the canonical attendance dimensions.",
      example: "present",
    },
    day_classification: {
      type: "string",
    ...
    approval_kind: {
      type: "string",
      enum: ["none", "regularization", "leave", "wfh", "multiple"],
      example: "none",
    },
    approval_state: {
      type: "string",
    ...
    payroll_state: {
      type: "string",
      enum: ["unprocessed", "not_applicable", "unknown"],
      description:
        "Neutral attendance-to-payroll projection state; no payability decision is implied.",
      example: "unprocessed",
    },
    ...
    work_seconds: {
      type: "integer",
      minimum: 0,
      description: "Canonical worked duration in whole seconds.",
      example: 33000,
    },
    break_seconds: {
      type: "integer",
      minimum: 0,
      description: "Canonical break duration in whole seconds.",
      example: 1800,
    },
    scheduled_seconds: {
      type: "integer",
      minimum: 0,
      description: "Effective shift duration in whole seconds.",
      example: 28800,
    },
    late_seconds: {
      type: "integer",
      minimum: 0,
      description: "Late-arrival duration in whole seconds.",
      example: 0,
    },
    early_departure_seconds: {
      type: "integer",
      minimum: 0,
      description: "Early-departure duration in whole seconds.",
      example: 0,
    },
    work_minutes: {
      type: "integer",
      minimum: 0,
      description:
        "Legacy compatibility duration in whole minutes, derived by flooring work_seconds / 60.",
      example: 550,
    },
    ...
    break_minutes: {
      type: "integer",
      minimum: 0,
      description: "Legacy compatibility duration in whole minutes.",
      example: 30,
    },
    late_minutes: {
      type: "integer",
...
const attendanceRegularizationCreateBody = {
  ...
  properties: {
    ...
    requested_punches: {
      ...
      deprecated: true,
      description:
        "Deprecated compatibility input. Each entry is normalized to an ADD item; use items for new clients.",
      minItems: 1,
      maxItems: 20,
      items: {
        type: "object",
        ...
        oneOf: [
          {
            ...
            properties: {
              operation: {
                type: "string",
                enum: [AttendanceRegularizationOperations.Add],
              },
              event_type: {
                type: "string",
                enum: enumValues(AttendanceHistoricalCorrectionEventTypeValues),
          ...
          },
          {
            ...
            properties: {
              operation: {
                type: "string",
                enum: [AttendanceRegularizationOperations.Replace],
              },
          ...
          },
          {
            ...
            properties: {
              operation: {
                type: "string",
                enum: [AttendanceRegularizationOperations.Void],
              },
              target_punch_event_id: uuid("Target punch event UUID"),
            },
            additionalProperties: false,
...
const attendanceRegularizationDecisionBody = {
  ...
  properties: {
    ...
    remarks: {
      type: "string",
      description: "Required for reject/return decisions.",
      example: "Approved.",
    },
    expected_version: { type: "integer", minimum: 1, example: 1 },
  },
...
const attendanceRegularizationSchema = {
  ...
  properties: {
    ...
    requested_punches: {
      ...
      deprecated: true,
      description:
        "Deprecated compatibility representation derived from normalized items. Includes ADD and REPLACE values and cannot represent VOID operations.",
      items: { type: "object", additionalProperties: true },
    },
    items: {
      type: "array",
      items: {
        ...
        properties: {
          ...
          operation: {
            type: "string",
            enum: Object.values(AttendanceRegularizationOperations),
          },
          target_punch_event_id: {
            ...uuid("Target punch event UUID"),
            nullable: true,
          },
          event_type: {
            type: "string",
          ...
          occurred_at: {
            ...dateTime("Requested punch timestamp"),
            nullable: true,
          },
        },
        additionalProperties: true,
    ...
    status: {
      type: "string",
      enum: Object.values(AttendanceRegularizationStatuses),
      example: "pending",
    },
    current_approver_user_id: {
      ...uuid("Current approver user UUID"),
      nullable: true,
    },
...
const attendanceOfflineEventEnvelopeSchema = {
  ...
  properties: {
    ...
    command_kind: {
      type: "string",
      enum: ["employee_manual_now"],
      example: "employee_manual_now",
    },
    captured_at: dateTime(
      "Client capture timestamp with offset. Server time remains authoritative for command execution.",
    ),
    source: {
      type: "string",
      enum: ["mobile_offline"],
      default: "mobile_offline",
      example: "mobile_offline",
    },
    event_type: {
      type: "string",
      enum: Object.values(AttendancePunchEventTypes),
    ...
    metadata: {
      ...
      properties: {
        ...
        app_state: {
          type: "string",
          enum: ["foreground", "background", "terminated", "unknown"],
        },
        capture_method: {
          type: "string",
          enum: ["user_action", "system_retry"],
        },
        client_timezone: {
          type: "string",
          minLength: 1,
...
const attendanceOfflineBatchEnvelopeSchema = {
  ...
  properties: {
    contract_version: {
      type: "string",
      enum: [AttendanceOfflineSyncContractVersion],
      example: AttendanceOfflineSyncContractVersion,
    },
...
const attendanceOfflineSyncResultSchema = {
  ...
  properties: {
    ...
    sync_status: {
      type: "string",
      enum: enumValues(AttendanceOfflineSyncStatusValues),
      example: "accepted",
    },
    verification_status: {
      type: "string",
      enum: enumValues(AttendanceOfflineVerificationStatusValues),
      example: "unverified",
    },
    ...
    processed_at: {
      ...dateTime("Server processing timestamp"),
      nullable: true,
    },
    payroll_eligible: {
      type: "boolean",
      enum: [false],
      description: "Offline results do not imply payroll eligibility.",
      example: false,
    },
  },
  additionalProperties: false,
...
const attendanceExportBody = {
  ...
  properties: {
    ...
    columns: {
      ...
      maxItems: 80,
      items: { type: "string", maxLength: 80 },
      example: ["employee_code", "employee", "date", "status"],
    },
    format: {
      type: "string",
      enum: ["csv", "xlsx", "json"],
...
const attendanceExportResponseSchema = {
  ...
  properties: {
    ...
    file_name: {
      type: "string",
      nullable: true,
      example: "attendance-export-2026-05-23.csv",
    },
    row_count: { type: "integer", minimum: 0, example: 25 },
    size_bytes: { type: "integer", nullable: true, minimum: 0, example: 2048 },
    generated_at: {
...
const leaveWfhQuerySchema = {
  ...
  properties: {
    ...
    leave_type: {
      type: "string",
      enum: ["casual", "sick", "earned", "unpaid", "comp_off"],
      example: "casual",
    },
    status: {
      type: "string",
...
const wfhRequestCreateBody = {
  ...
  properties: {
    ...
    reason: {
      ...
      minLength: 3,
      maxLength: 1000,
      example: "Remote work due to home installation",
    },
...
const leaveWfhExportResponseSchema = {
  ...
  properties: {
    ...
    file_name: {
      type: "string",
      nullable: true,
      example: "leave-wfh-export-2026-05-23.csv",
    },
    row_count: { type: "integer", minimum: 0, example: 25 },
    size_bytes: { type: "integer", nullable: true, minimum: 0, example: 2048 },
    generated_at: {
...
const emsProfilePatchBody = {
  ...
  properties: {
    personal_email: {
      type: "string",
      format: "email",
      example: "employee.personal@example.com",
    },
...
const emsProfileChangeCreateBody = {
  ...
  properties: {
    ...
    supporting_document_ids: {
      type: "array",
      items: uuid("Supporting document UUID"),
    },
  },
  additionalProperties: false,
};
...
const emsRequestCreateBody = {
  ...
  properties: {
    ...
    description: {
      type: "string",
      example: "Please help me verify my PF nomination status.",
    },
    document_ids: { type: "array", items: uuid("Supporting document UUID") },
  },
  additionalProperties: false,
...
const emsServiceRequestDecisionBody = {
  ...
  properties: {
    decision: {
      type: "string",
      enum: ["approved", "returned", "rejected", "closed"],
      example: "approved",
    },
...
const emsLetterSchema = {
  ...
  properties: {
    ...
    status: {
      type: "string",
      enum: ["available", "requested", "in_progress", "acknowledged"],
      example: "available",
    },
...
const emsAdminChecklistSchema = {
  ...
  properties: {
    ...
    completed_at: {
      ...dateTime("Checklist completion timestamp"),
      nullable: true,
    },
    version: { type: "integer", minimum: 1, example: 1 },
  },
...
const emsProbationReviewSchema = {
  ...
  properties: {
    ...
    status: {
      type: "string",
      enum: ["pending", "confirmed", "extended"],
      example: "pending",
    },
    extended_until: {
      type: "string",
...
const commonErrorResponses = {
  400: {
    description: "Validation failed or invalid business request.",
    content: {
      "application/json": {
...
const rateLimitErrorResponse = {
  429: {
    description: "Rate limit exceeded. Retry after the documented delay.",
    content: {
      "application/json": {
...
const operation = (
  ...
  response: {
    200: success(
      (options.response200 as JsonSchema | undefined) ?? statusResponseSchema,
    ),
...
const expenseReportQuerySchema = {
  ...
  properties: {
    ...
    expense_sub_type: {
      type: "string",
      description: "Expense subtype filter.",
      example: "Project Travel",
    },
    payment_type: {
      type: "string",
    ...
    document_status: {
      type: "string",
      enum: ["any", "complete", "missing", "pending", "not_required"],
      default: "any",
      example: "missing",
    },
  },
...
const documentSummarySchema = {
  ...
  properties: {
    status: {
      type: "string",
      enum: ["complete", "missing", "pending", "not_required"],
      example: "missing",
    },
    required_document_types: {
      type: "array",
...
const workflowSummarySchema = {
  ...
  properties: {
    ...
    action_required_by: {
      type: "string",
      enum: ["requester", "manager", "finance", "none"],
      example: "finance",
    },
...
const registerReportSchema = {
  ...
  properties: {
    ...
    export_columns: {
      type: "array",
      items: { type: "string" },
      example: ["ticket_no", "payment_reference_no"],
    },
  },
  additionalProperties: true,
};
...
const reportExportJobSchema = {
  ...
  properties: {
    ...
    file_name: {
      type: "string",
      nullable: true,
      example: "report-hr-employees-2026-05-23.csv",
    },
    row_count: { type: "integer", minimum: 0, example: 25 },
    size_bytes: { type: "integer", nullable: true, minimum: 0, example: 2048 },
    generated_at: {
...
const timesheetApproverQueueQuerySchema = {
  ...
  properties: {
    ...
    status: {
      type: "string",
      enum: ["Pending Approval", "Approved", "Returned", "Rejected"],
      description:
        "Optional queue status filter. Omit for active pending approvals.",
      example: "Pending Approval",
    },
    employee_user_id: uuid("Employee/member UUID filter"),
    cycle_start: date(
      "Only cycles starting on or after this date",
      "2026-05-04",
    ),
    ...
    project_code: {
      ...
      minLength: 1,
      description:
        "Project code present in at least one submitted work segment.",
      example: "PRJ-100",
    },
    billable: {
      type: "boolean",
      description:
        "When set, requires at least one matching billable/non-billable segment.",
      example: true,
    },
  },
};
...
const timesheetAnalyticsQuerySchema = {
  ...
  properties: {
    ...
    group_by: {
      type: "string",
      enum: ["employee", "project", "department", "week"],
      example: "employee",
    },
  },
};
...
const timesheetSelectorsQuerySchema = {
  ...
  properties: {
    include: {
      type: "string",
      description: "Comma-separated selector groups to include.",
      example: "projects,tasks,cycles,approvers,rules",
    },
...
const timesheetSubmissionResponseSchema = {
  ...
  properties: {
    ...
    member: {
      ...
      additionalProperties: true,
      description:
        "Employee/member profile, department/designation, member_role, and manager reference.",
    },
    cycle: {
      type: "object",
    ...
    workflow_metadata: {
      ...
      properties: {
        ...
        allowed_decisions: {
          type: "array",
          items: { type: "string", enum: ["approve", "return", "reject"] },
          example: ["approve", "return", "reject"],
        },
        remarks_required_for: {
          type: "array",
          items: { type: "string" },
          example: ["return", "reject"],
        },
      },
      additionalProperties: true,
    },
  ...
  properties: {
    ...
    items: {
      ...
      items: {
        ...
        required: [
          ...(timesheetSubmissionResponseSchema.required as string[]),
          "queue_context",
          "decision_history",
          "last_decision",
        ],
        properties: {
          ...
          queue_context: {
            ...
            required: [
              "action_required",
              "current_actor_is_admin_override",
              "expected_version",
...
const expenseCreateBody = {
  ...
  properties: {
    submit: {
      type: "boolean",
      default: false,
      description: "When true, route immediately into the approval workflow.",
      example: true,
    },
    expense_type: {
      type: "string",
    ...
    project_code: {
      type: "string",
      description: "Required for Project expenses.",
      example: "PRJ-100",
    },
    client_name: {
      type: "string",
      description: "Required for Sales/Pre-Sales expenses.",
      example: "Northwind",
    },
    task_title: {
      type: "string",
      minLength: 1,
      example: "Client implementation travel",
    },
    task_description: {
      type: "string",
      minLength: 1,
      example: "Travel for implementation workshop",
    },
    ...
    advance_justification: {
      type: "string",
      example: "Client travel requires upfront payment.",
    },
    line_items: {
      type: "array",
      minItems: 1,
...
const financeVerifyBody = {
  ...
  properties: {
    decision: {
      type: "string",
      enum: ["verify", "hold", "clarification"],
      example: "verify",
    },
    remarks: {
      type: "string",
      description: "Required for hold or clarification.",
...
const settlementBody = {
  ...
  properties: {
    ...
    remarks: {
      type: "string",
      example: "Bills verified and settlement complete.",
    },
...
const expenseWithdrawBody = {
  ...
  properties: {
    ...
    remarks: {
      type: "string",
      description: "Required once the ticket has been submitted.",
      example: "Trip cancelled before manager approval.",
    },
  },
  additionalProperties: false,
};
...
const expenseClarificationBody = {
  ...
  properties: {
    message: {
      ...
      minLength: 1,
      maxLength: 4000,
      example: "Please attach the GST invoice for this claim.",
    },
    document_ids: {
      type: "array",
      items: uuid("Document metadata UUID"),
      default: [],
    },
    expected_version: { type: "integer", minimum: 1, example: 2 },
  },
...
const projectQuerySchema = {
  ...
  properties: {
    ...
    include: {
      type: "string",
      example: "members,allocations,milestones,documents,summary",
    },
...
const projectBody = {
  ...
  properties: {
    ...
    name: {
      ...
      minLength: 2,
      maxLength: 180,
      example: "Atlas Payments Platform",
    },
    client_name: {
      type: "string",
      minLength: 1,
    ...
    billing_type: {
      type: "string",
      enum: ["fixed", "hourly", "retainer", "internal"],
      default: "fixed",
      example: "fixed",
    },
    manager_user_id: uuid("Project manager user UUID"),
    ...
    description: {
      type: "string",
      maxLength: 2000,
      example: "Client implementation project.",
    },
...
const projectArchiveBody = {
  ...
  properties: {
    remarks: {
      type: "string",
      example: "Delivery completed and documents archived.",
    },
    expected_version: { type: "integer", minimum: 1, example: 3 },
  },
  additionalProperties: false,
...
const projectAllocationBody = {
  ...
  properties: {
    ...
    notes: {
      type: "string",
      example: "Ramp to full-time allocation next sprint.",
    },
    expected_version: { type: "integer", minimum: 1, example: 2 },
  },
  additionalProperties: false,
...
const helpdeskQuerySchema = {
  ...
  properties: {
    ...
    category_key: {
      type: "string",
      enum: ["IT", "HR", "Finance", "Admin", "Assets", "Project Support"],
      example: "IT",
    },
...
const helpdeskCategorySchema = {
  ...
  properties: {
    ...
    default_assignee_user_id: {
      ...uuid("Default assignee user UUID"),
      nullable: true,
    },
...
const helpdeskCategoryCreateBody = {
  ...
  properties: {
    ...
    sub_categories: {
      type: "array",
      maxItems: 40,
      items: helpdeskSubCategorySchema,
    },
  },
  additionalProperties: false,
};
...
const helpdeskTicketBody = {
  ...
  properties: {
    ...
    description: {
      ...
      minLength: 3,
      maxLength: 4000,
      example: "The VPN client times out after 30 seconds.",
    },
...
const helpdeskResolveBody = {
  ...
  properties: {
    resolution: {
      ...
      minLength: 3,
      maxLength: 2000,
      example: "Reset VPN profile and confirmed connection.",
    },
    document_ids: { type: "array", items: uuid("Document UUID") },
    expected_version: { type: "integer", minimum: 1, example: 2 },
  },
...
const helpdeskReopenBody = {
  ...
  properties: {
    reason: {
      ...
      minLength: 3,
      maxLength: 1000,
      example: "The same VPN error returned.",
    },
    expected_version: { type: "integer", minimum: 1, example: 4 },
  },
  additionalProperties: false,
...
const notificationSchema = {
  ...
  properties: {
    ...
    description: {
      type: "string",
      example: "Employee E1 submitted the current week for approval.",
    },
    category: {
      type: "string",
      enum: ["approval", "mention", "system", "alert"],
      example: "approval",
    },
    action_url: {
      type: "string",
...
const documentUploadBody = {
  ...
  properties: {
    ...
    checksum_sha256: {
      type: "string",
      example: "b94d27b9934d3e08a52e52d7da7dabfade",
    },
  },
  description:
  ...
  properties: {
    ...
    company_logo: {
      ...
      properties: {
        ...
        cloudinary_transformation: {
          type: "string",
          example: "c_fit,w_512,h_512,q_auto:eco,f_auto",
        },
      },
      additionalProperties: false,
    },
...
const expenseDocumentUploadBody = {
  ...
  properties: without(documentUploadBody.properties as RouteSchema, [
    "business_object_type",
    "business_object_id",
  ]),
};
...
const routeDocs: Record<string, RouteSchema> = {
  "GET /health/live": operation(
    "Platform / Health",
    "Liveness check",
    "Unversioned container liveness probe.",
    { response200: statusResponseSchema, rateLimited: false },
    false,
  ),
  "GET /health/ready": operation(
    "Platform / Health",
    "Readiness check",
    "Unversioned readiness probe showing configured PostgreSQL, Valkey, and object-storage adapters.",
    { response200: statusResponseSchema, rateLimited: false },
    false,
  ),
  "GET /api/v1/health/live": operation(
    "Platform / Health",
    "Versioned liveness check",
    "Versioned liveness probe for API clients.",
    { response200: statusResponseSchema, rateLimited: false },
    false,
  ),
  "GET /api/v1/health/ready": operation(
    "Platform / Health",
    "Versioned readiness check",
    "Versioned readiness probe for API clients.",
    { response200: statusResponseSchema, rateLimited: false },
    false,
  ),
  "GET /api/v1/openapi.json": operation(
    "Platform / Health",
    "OpenAPI JSON",
    "Returns the generated OpenAPI 3.0 contract used by Swagger UI.",
    {
  ...
  "POST /api/v1/webhooks/resend": operation(
    "Platform / Health",
    "Resend webhook",
    "Accepts Resend transactional email webhooks after raw-body Svix signature verification, stores deduplicated provider events, and updates email delivery status. Webhook events never mark a user email as verified.",
    {
  ...
  "POST /api/v1/auth/signup": operation(
    "Auth & Sessions",
    "Signup",
    "Creates a pending workspace signup identity with hashed token-based email verification and queues a transactional verification email. Duplicate verified emails and bootstrapped company slugs return 409. Password is optional; if omitted, verify-email leads to set-password. Local/QA responses include dev_only tokens for automation; production omits them.",
    { body: signupBodySchema, response200: signupResponseSchema },
    false,
  ),
  "POST /api/v1/auth/verify-email": operation(
    "Auth & Sessions",
    "Verify email",
    "Consumes a one-time app-owned email verification token, marks the user email as verified, activates the pending identity when a password exists, or issues a password setup action when no password was supplied. Resend webhook events are not trusted for verification. Reused tokens return 409 and expired/invalid tokens return 400.",
    { body: verifyEmailBodySchema, response200: verifyEmailResponseSchema },
    false,
  ),
  "POST /api/v1/auth/email-verifications/resend": operation(
    "Auth & Sessions",
    "Resend email verification",
    "Enumeration-safe resend endpoint for pending signups. The response is accepted for unknown or already-verified emails and does not reveal whether an email was sent; pending users are protected by cooldown/hourly/daily resend limits. Local/QA may include a dev_only token when a pending identity exists.",
    {
      body: resendEmailVerificationBodySchema,
      response200: resendEmailVerificationResponseSchema,
    },
    false,
  ),
  "POST /api/v1/auth/set-password": operation(
    "Auth & Sessions",
    "Set password",
    "Sets the initial password for an invited or verified account using a one-time password_setup token. Password confirmation is required, reused tokens return 409, and successful setup enables login.",
    { body: passwordSetBodySchema, response200: setPasswordResponseSchema },
    false,
  ),
  "POST /api/v1/auth/password-reset/request": operation(
    "Auth & Sessions",
    "Request password reset",
    "Enumeration-safe password reset request. The response shape is the same for existing and unknown emails; Local/QA may include a dev_only token only for automation.",
    {
      body: resendEmailVerificationBodySchema,
      response200: passwordResetRequestResponseSchema,
    },
    false,
  ),
  "POST /api/v1/auth/password-reset/confirm": operation(
    "Auth & Sessions",
    "Confirm password reset",
    "Consumes a one-time password_reset token, replaces the active password hash, and revokes active sessions for the user. Reused tokens return 409 and invalid/expired tokens return 400.",
    {
      body: passwordSetBodySchema,
      response200: passwordResetConfirmResponseSchema,
    },
    false,
  ),
  "POST /api/v1/onboarding/company-logo": operation(
    "Auth & Sessions",
    "Upload onboarding company logo",
    "Uploads the pending company logo through the backend object-storage adapter using an active company bootstrap token. Images follow the global media upload policy and are transformed by Cloudinary when real storage is configured.",
    {
      body: companyLogoUploadBodySchema,
      response200: {
        type: "object",
        required: ["company", "document"],
        properties: {
          company: adminCompanyProfileSchema,
  ...
  "POST /api/v1/onboarding/company-bootstrap": operation(
    "Auth & Sessions",
    "Company bootstrap",
    "Completes first-company setup using the one-time company bootstrap token issued after email verification. The bootstrap user is promoted to Admin, company preferences are saved, and duplicate bootstrap attempts return 409.",
    {
      body: companyBootstrapBodySchema,
      response200: companyBootstrapResponseSchema,
    },
    false,
  ),
  "PATCH /api/v1/auth/session/preference": operation(
    "Auth & Sessions",
    "Update session preference",
    "Persists active role, optional company context, landing page, locale, and timezone for the current authenticated user. The selected role must already be assigned to the user; otherwise the backend returns 403.",
    {
      body: sessionPreferenceBodySchema,
  ...
  "POST /api/v1/auth/login": operation(
    ...
    "Authenticates the platform using email/password and establishes shared session context for all web zones. Successful login also sets the configured HttpOnly session cookie. A DEV-only `employee_code` fallback remains available for local QA scripts, but the primary consumer contract is email/password.",
    {
      body: {
        ...
        properties: {
          email: {
            ...
            format: "email",
            description:
              "Seeded local QA user email. Example is the Finance Manager persona.",
          ...
          password: {
            ...
            minLength: 8,
            description:
              "Local Docker QA demo password. Never send this in URLs or logs.",
          ...
          employee_code: {
            ...
            minLength: 1,
            description:
              "DEV-only fallback for legacy local QA scripts. Primary UI and consumer docs use email/password.",
            example: "N1",
          },
        },
      ...
      response200: {
        ...
        properties: {
          ...
          access_token: {
            type: "string",
            description:
              "JWT access token for API clients. Do not hard-code this value.",
      ...
      response: {
        401: {
          description: "Invalid email/password or inactive session.",
          content: { "application/json": { schema: errorResponseSchema } },
        },
        403: {
          description: "Inactive or blocked user if policy denies login.",
          content: { "application/json": { schema: errorResponseSchema } },
        },
      },
    },
  ...
  "POST /api/v1/platform/devices": operation(
    "Platform / Devices",
    "Register mobile device",
    "Registers the authenticated user's mobile app installation in the active company using a tenant-scoped lowercase SHA-256 installation hash. The server derives company and owner from the authenticated active-company context. First registration creates the device and emits platform.device.registered transactionally with HTTP 201; same-owner retries for an already registered device return the existing device with HTTP 200 and do not emit another event. Cross-owner claims and suspended or revoked devices return 409.",
    {
      body: platformDeviceRegistrationBodySchema,
      response200: platformRegisteredDeviceSchema,
      response: {
        201: success(platformRegisteredDeviceSchema, "Device registered."),
      },
    },
  ),
  "GET /api/v1/platform/devices": operation(
    "Platform / Devices",
    "List my mobile devices",
    "Lists registered, suspended, and revoked mobile devices owned by the authenticated actor in the active company. The backend scopes by both company_id and user_id derived from server context.",
    { response200: platformRegisteredDeviceListSchema },
  ),
  "POST /api/v1/platform/devices/{deviceId}/revoke": operation(
    "Platform / Devices",
    "Revoke registered device",
    "Revokes a registered or suspended device in the authenticated active company. Device owners may revoke their own device; Admin may revoke any device in their active company. Revoked is terminal. Same-state retries are idempotent and emit no duplicate lifecycle event.",
    {
      params: deviceIdParamSchema,
      body: platformDeviceLifecycleBodySchema,
      response200: platformRegisteredDeviceSchema,
    },
  ),
  "POST /api/v1/platform/devices/{deviceId}/suspend": operation(
    "Platform / Devices",
    "Suspend registered device",
    "Admin-only lifecycle action that suspends a registered device in the Admin's active company. Same-state retries are idempotent and emit no duplicate lifecycle event.",
    {
      params: deviceIdParamSchema,
      body: platformDeviceLifecycleBodySchema,
      response200: platformRegisteredDeviceSchema,
  ...
  "POST /api/v1/platform/devices/{deviceId}/restore": operation(
    "Platform / Devices",
    "Restore suspended device",
    "Admin-only lifecycle action that restores a suspended device to registered in the Admin's active company. Revoked devices cannot be restored. Same-state retries are idempotent and emit no duplicate lifecycle event.",
    {
      params: deviceIdParamSchema,
      body: platformDeviceLifecycleBodySchema,
      response200: platformRegisteredDeviceSchema,
  ...
  "GET /api/v1/core/master-data/org-selectors": operation(
    "Core / Employees & Hierarchy",
    "Org selectors",
    "Returns active departments, designations, manager candidates, and backend role labels used by employee create/edit forms. The list is scoped by the authenticated actor where manager visibility is restricted.",
    { response200: orgSelectorsResponseSchema },
  ),
  "GET /api/v1/core/users": operation(
    "Core / Employees & Hierarchy",
    "List users",
    "Paginated employee/user search for authorized modules and admins. Supports frontend table filters, manager scoping, login-state filters, sorting, compact org references, and summary counts.",
    {
      querystring: {
        ...paginationQuerySchema,
        properties: {
          ...
          q: {
            type: "string",
            description: "Optional employee code/name/email search.",
            example: "E1",
          },
          ...
          role: {
            type: "string",
            description: "Filter by assigned role label.",
            example: "Employee",
          },
          employment_status: {
            type: "string",
          ...
          manager_user_id: uuid("Filter by direct manager UUID"),
          login_state: {
            type: "string",
            enum: ["enabled", "disabled", "setup_pending"],
            example: "enabled",
      ...
      response200: coreUserListResponseSchema,
    },
  ),
  "POST /api/v1/core/users": operation(
    "Core / Employees & Hierarchy",
    "Create user",
    "Creates a Core employee profile with department, designation, reporting manager, roles, lifecycle status, and optional password setup action. The API never creates a shared/default production password; login enablement queues password setup.",
    {
      body: coreUserCreateBodySchema,
      response200: coreUserMutationResponseSchema,
    },
  ),
  "GET /api/v1/core/users/profile-photo-policy": operation(
    "Core / Employees & Hierarchy",
    "Get profile photo upload policy",
    "Returns backend-owned profile photo upload limits, allowed image MIME types, compression dimensions, and Cloudinary upload transformation so clients can compress before upload.",
    { response200: coreProfilePhotoPolicySchema },
  ),
  "GET /api/v1/core/users/{id}": operation(
    "Core / Employees & Hierarchy",
    "Get user",
    "Returns one Core employee/user record with reporting line, role assignments, login state, and compact cross-module summaries for employee detail tabs.",
    { params: idParamSchema, response200: coreUserDetailSchema },
  ),
  "PATCH /api/v1/core/users/{id}": operation(
    "Core / Employees & Hierarchy",
    "Update user",
    "Updates an employee profile, org placement, manager, lifecycle fields, and optimistic concurrency version. Manager changes update descendant hierarchy paths and block hierarchy cycles.",
    {
      params: idParamSchema,
      body: coreUserUpdateBodySchema,
      response200: coreUserMutationResponseSchema,
    },
  ),
  "POST /api/v1/core/users/{id}/profile-photo": operation(
    "Core / Employees & Hierarchy",
    "Upload profile photo",
    "Uploads a compressed employee profile photo through the document storage pipeline. Admin/HR can update employee photos; employees can update their own. Real storage uses Cloudinary with a profile-specific transformation.",
    {
      params: idParamSchema,
      body: coreProfilePhotoUploadBodySchema,
      response200: coreUserMutationResponseSchema,
    },
  ),
  "DELETE /api/v1/core/users/{id}/profile-photo": operation(
    "Core / Employees & Hierarchy",
    "Remove profile photo",
    "Deletes the current profile-photo document when one exists and clears profile photo metadata. Admin/HR can remove employee photos; employees can remove their own.",
    { params: idParamSchema, response200: coreUserMutationResponseSchema },
  ),
  "POST /api/v1/core/users/{id}/activate": operation(
    "Core / Employees & Hierarchy",
    "Activate user",
    "Reactivates an inactive, suspended, or terminated employee profile with optimistic concurrency protection.",
    {
      params: idParamSchema,
      body: coreUserStatusBodySchema,
      response200: coreUserMutationResponseSchema,
    },
  ),
  "POST /api/v1/core/users/{id}/deactivate": operation(
    "Core / Employees & Hierarchy",
    "Deactivate user",
    "Deactivates, suspends, or terminates an employee, revokes active login credentials, and emits a platform event for downstream offboarding workflows such as asset recovery.",
    {
      params: idParamSchema,
      body: coreUserStatusBodySchema,
      response200: coreUserMutationResponseSchema,
  ...
  "POST /api/v1/core/users/{id}/login/enable": operation(
    "Core / Employees & Hierarchy",
    "Enable login setup",
    "Starts login enablement by issuing a one-time password setup action. Local/QA responses include a dev_only token; production must deliver the setup action via configured email/notification provider before sign-in succeeds.",
    {
      params: idParamSchema,
      body: coreUserLoginBodySchema,
      response200: coreUserMutationResponseSchema,
    },
  ),
  "POST /api/v1/core/users/{id}/login/disable": operation(
    "Core / Employees & Hierarchy",
    "Disable login",
    "Revokes active user credentials, revokes active sessions where the session store supports it, and marks login disabled with optimistic concurrency protection.",
    {
      params: idParamSchema,
      body: coreUserLoginBodySchema,
      response200: coreUserMutationResponseSchema,
  ...
  "PUT /api/v1/core/users/{id}/roles": operation(
    "Core / Employees & Hierarchy",
    "Replace roles",
    "Replaces backend role assignments for an employee. Admin can assign all roles; HR Manager can assign non-admin roles and cannot modify admin users. Active session preference is adjusted if the previous active role is removed.",
    {
      params: idParamSchema,
      body: coreUserRolesBodySchema,
      response200: coreUserMutationResponseSchema,
    },
  ),
  "GET /api/v1/core/users/{id}/roles/history": operation(
    "Core / Employees & Hierarchy",
    "Role assignment history",
    "Returns a paginated role assignment timeline backed by durable core user outbox events. Admin, HR Manager, Auditor, and the employee themself can read it; managers do not receive sensitive role history unless they have HR/Admin/Auditor scope.",
    {
      params: idParamSchema,
      querystring: paginationQuerySchema,
      response200: {
        ...paginated(coreUserRoleHistoryEntrySchema),
        additionalProperties: true,
      },
    },
  ),
  "GET /api/v1/core/users/{id}/audit": operation(
    "Core / Employees & Hierarchy",
    "Employee audit trail",
    "Returns profile, lifecycle, login, and role audit events for an employee. Secret/token-like payload keys are redacted before returning metadata.",
    {
      params: idParamSchema,
      querystring: coreUserAuditQuerySchema,
      response200: {
        ...paginated(coreUserAuditEntrySchema),
        additionalProperties: true,
      },
    },
  ),
  "POST /api/v1/core/users/imports": operation(
    "Core / Employees & Hierarchy",
    "Create employee import job",
    "Queues an employee import job from an uploaded document reference or file metadata. This slice records durable job metadata in the transactional outbox; row parsing and generated user creation remain production hardening work.",
    { body: coreUserImportBodySchema, response200: coreUserImportJobSchema },
  ),
  "GET /api/v1/core/users/imports/{job_id}": operation(
    "Core / Employees & Hierarchy",
    "Get employee import job",
    "Returns an employee import job status, counts, row errors, and created-user preview from durable outbox metadata.",
    { params: coreImportJobParamSchema, response200: coreUserImportJobSchema },
  ),
  "POST /api/v1/core/users/exports": operation(
    "Core / Employees & Hierarchy",
    "Create employee export job",
    "Creates CSV or XLSX employee export documents for HR/Admin/Auditor users when object storage is configured.",
  ...
  "GET /api/v1/core/users/{id}/subtree": operation(
    ...
    "Returns the active, non-deleted subordinate hierarchy below a user. Admin, HR Manager, and Auditor can inspect any active root; other actors can inspect only self or a root inside their own hierarchy path. The response is backed by the ltree-style hierarchy path and includes relative depth and summary counts.",
    {
      params: idParamSchema,
      querystring: paginationQuerySchema,
      response200: subtreeResponseSchema,
    },
  ),
  ...
  "POST /api/v1/projects": operation(
    ...
    "Create project",
    "Creates a project with core delivery metadata, owning manager, dates, budget/effort estimates, and optimistic concurrency version. Admin can create for any active manager; non-admin managers can create projects for themselves.",
    {
      body: projectBody,
      response200: {
        type: "object",
  ...
  "GET /api/v1/projects": operation(
    "Projects / Utilization",
    "List projects",
    "Lists projects visible to portfolio roles, assigned project managers, reporting managers, and project members. Supports status, client, manager, search, pagination, and totals.",
    {
      querystring: projectQuerySchema,
      response200: { ...paginated(projectSchema), additionalProperties: true },
    },
  ),
  "GET /api/v1/projects/{id}": operation(
    "Projects / Utilization",
    "Project detail",
    "Returns one project detail with optional included members, allocation history, milestones/modules, documents, and summary data.",
    {
      params: idParamSchema,
      querystring: projectQuerySchema,
      response200: projectSchema,
    },
  ),
  "PATCH /api/v1/projects/{id}": operation(
    "Projects / Utilization",
    "Update project",
    "Updates project metadata with optimistic concurrency protection. Only Admin or the assigned project manager can mutate the project.",
    {
      params: idParamSchema,
  ...
  "POST /api/v1/projects/{id}/archive": operation(
    "Projects / Utilization",
    "Archive project",
    "Archives a project with optimistic concurrency. Active projects with active members must first be moved out of active delivery state or members removed.",
    {
      params: idParamSchema,
  ...
  "GET /api/v1/projects/{id}/members": operation(
    "Projects / Utilization",
    "List project members",
    "Lists members assigned to a project with active-only and role filters.",
    {
      params: idParamSchema,
      querystring: projectQuerySchema,
      response200: paginated({ type: "object", additionalProperties: true }),
    },
  ),
  "POST /api/v1/projects/{id}/members": operation(
    "Projects / Utilization",
    "Add project member",
    "Adds an active employee to a project and creates the initial allocation row with project-level optimistic concurrency.",
    {
      params: idParamSchema,
  ...
  "PATCH /api/v1/projects/{id}/members/{member_id}": operation(
    "Projects / Utilization",
    "Update project member",
    "Updates or removes a project member with member-level optimistic concurrency and returns project version/capacity warnings.",
    {
      params: {
        type: "object",
        ...
        properties: {
          id: uuid("Project UUID"),
          member_id: uuid("Project member UUID"),
        },
      },
  ...
  "GET /api/v1/projects/{id}/allocations": operation(
    "Projects / Utilization",
    "List allocation history",
    "Lists project allocation entries with employee and date-range filters, plus allocation totals.",
    {
      params: idParamSchema,
      querystring: projectQuerySchema,
      response200: {
  ...
  "POST /api/v1/projects/{id}/allocations": operation(
    "Projects / Utilization",
    "Create allocation",
    "Creates an allocation entry for an active project member, updates the member allocation snapshot, and returns capacity warnings.",
    {
      params: idParamSchema,
      body: projectAllocationBody,
      response200: { type: "object", additionalProperties: true },
    },
  ),
  "GET /api/v1/projects/{id}/milestones": operation(
    "Projects / Utilization",
    "List milestones",
    "Lists project modules/milestones visible to project-scoped users.",
    {
      params: idParamSchema,
      querystring: projectQuerySchema,
      response200: paginated({ type: "object", additionalProperties: true }),
  ...
  "POST /api/v1/projects/{id}/milestones": operation(
    "Projects / Utilization",
    "Create milestone",
    "Creates a project module/milestone with project-level optimistic concurrency.",
    {
      params: idParamSchema,
  ...
  "GET /api/v1/projects/{id}/documents": operation(
    "Projects / Utilization",
    "List project documents",
    "Lists project-scoped documents from the existing Documents module metadata. Downloads and verification continue through Documents APIs.",
    {
      params: idParamSchema,
      querystring: projectQuerySchema,
      response200: paginated({ type: "object", additionalProperties: true }),
  ...
  "GET /api/v1/projects/{id}/summary": operation(
    "Projects / Utilization",
    "Project summary",
    "Returns project cards, timesheet rollups, expense rollups, and allocation summary derived from implemented backend modules.",
    {
      params: idParamSchema,
      querystring: projectQuerySchema,
      response200: { type: "object", additionalProperties: true },
  ...
  "GET /api/v1/team-utilization/summary": operation(
    "Projects / Utilization",
    "Team utilization summary",
    "Returns bench, overload, capacity, billable/non-billable, and utilization analytics without client-side all-user aggregation.",
    {
      querystring: projectQuerySchema,
      response200: { type: "object", additionalProperties: true },
    },
  ),
  "POST /api/v1/helpdesk/tickets": operation(
    "Helpdesk",
    "Create helpdesk ticket",
    "Creates a helpdesk ticket for the authenticated employee, snapshots requester context, assigns the category default agent when configured, and starts SLA tracking server-side.",
    { body: helpdeskTicketBody, response200: helpdeskMutationResponse },
  ),
  "GET /api/v1/helpdesk/tickets": operation(
    "Helpdesk",
    "List helpdesk tickets",
    "Lists requester-owned, assigned, or category-scoped helpdesk tickets with pagination, filters, and queue counts.",
    {
      querystring: helpdeskQuerySchema,
      response200: {
        ...paginated(helpdeskTicketSchema),
        additionalProperties: true,
      },
    },
  ),
  "GET /api/v1/helpdesk/tickets/{id}": operation(
    "Helpdesk",
    "Helpdesk ticket detail",
    "Returns ticket detail, comments, attachments, events, SLA state, and optimistic concurrency version for authorized requesters and agents.",
    { params: idParamSchema, response200: helpdeskTicketSchema },
  ),
  "PATCH /api/v1/helpdesk/tickets/{id}": operation(
    "Helpdesk",
    "Update helpdesk ticket",
    "Updates allowed ticket fields with optimistic concurrency protection. Closed tickets must be reopened before mutation.",
    {
      params: idParamSchema,
      body: helpdeskTicketUpdateBody,
      response200: helpdeskMutationResponse,
    },
  ),
  "POST /api/v1/helpdesk/tickets/{id}/comments": operation(
    "Helpdesk",
    "Add public ticket comment",
    "Adds a requester-visible ticket comment and records first-response time when the first public agent response is added.",
    {
      params: idParamSchema,
      body: helpdeskCommentBody,
      response200: helpdeskMutationResponse,
    },
  ),
  "POST /api/v1/helpdesk/tickets/{id}/internal-notes": operation(
    "Helpdesk",
    "Add internal ticket note",
    "Adds an internal support note visible only to helpdesk agents and scoped managers.",
    {
      params: idParamSchema,
      body: helpdeskCommentBody,
      response200: helpdeskMutationResponse,
  ...
  "POST /api/v1/helpdesk/tickets/{id}/attachments": operation(
    "Helpdesk",
    "Attach helpdesk document",
    "Attaches backend document metadata or a local file reference to a ticket. Binary upload and secure download stay owned by the Documents module.",
    {
      params: idParamSchema,
      body: helpdeskAttachmentBody,
      response200: helpdeskMutationResponse,
    },
  ),
  "POST /api/v1/helpdesk/tickets/{id}/assign": operation(
    "Helpdesk",
    "Assign helpdesk ticket",
    "Assigns or reassigns a ticket to an active employee using optimistic concurrency and activity timeline events.",
    {
      params: idParamSchema,
      body: helpdeskAssignBody,
      response200: helpdeskMutationResponse,
    },
  ),
  "POST /api/v1/helpdesk/tickets/{id}/priority": operation(
    "Helpdesk",
    "Change helpdesk priority",
    "Changes priority, recalculates SLA, and requires remarks when escalating to urgent priority.",
    {
      params: idParamSchema,
      body: helpdeskPriorityBody,
      response200: helpdeskMutationResponse,
    },
  ),
  "POST /api/v1/helpdesk/tickets/{id}/status": operation(
    "Helpdesk",
    "Change helpdesk status",
    "Changes operational ticket status for assigned/category-scoped agents. Resolve and close use dedicated endpoints.",
    {
      params: idParamSchema,
      body: helpdeskStatusBody,
      response200: helpdeskMutationResponse,
    },
  ),
  "POST /api/v1/helpdesk/tickets/{id}/resolve": operation(
    "Helpdesk",
    "Resolve helpdesk ticket",
    "Resolves an open ticket with resolution notes, sets resolved timestamp, and preserves SLA metadata.",
    {
      params: idParamSchema,
      body: helpdeskResolveBody,
      response200: helpdeskMutationResponse,
    },
  ),
  "POST /api/v1/helpdesk/tickets/{id}/close": operation(
    "Helpdesk",
    "Close helpdesk ticket",
    "Closes a resolved ticket by requester or agent with optimistic concurrency protection.",
    {
      params: idParamSchema,
      body: helpdeskCloseBody,
      response200: helpdeskMutationResponse,
    },
  ),
  "POST /api/v1/helpdesk/tickets/{id}/reopen": operation(
    "Helpdesk",
    "Reopen helpdesk ticket",
    "Reopens a resolved or closed ticket with a requester/agent reason and increments reopen count.",
    {
      params: idParamSchema,
      body: helpdeskReopenBody,
      response200: helpdeskMutationResponse,
    },
  ),
  "GET /api/v1/helpdesk/categories": operation(
    "Helpdesk",
    "List helpdesk categories",
    "Returns active ticket categories, default routing metadata, sub-categories, and SLA hints used by the raise-ticket flow.",
    {
      querystring: helpdeskQuerySchema,
      response200: {
        type: "object",
        required: ["categories", "sla"],
        properties: {
          categories: { type: "array", items: helpdeskCategorySchema },
          sla: { type: "object", additionalProperties: true },
          actor_scope: { type: "string", example: "requester" },
        },
        additionalProperties: true,
      },
    },
  ),
  "POST /api/v1/helpdesk/categories": operation(
    "Helpdesk",
    "Create helpdesk category",
    "Creates a helpdesk category configuration for scoped helpdesk managers. Category keys use the current supported category set so ticket routing remains compatible with role scopes.",
    {
      body: helpdeskCategoryCreateBody,
      response200: helpdeskCategoryMutationResponse,
    },
  ),
  "PATCH /api/v1/helpdesk/categories/{id}": operation(
    "Helpdesk",
    "Update helpdesk category",
    "Updates helpdesk category routing, active status, and sub-categories with optimistic concurrency.",
    {
      params: idParamSchema,
      body: helpdeskCategoryUpdateBody,
      response200: helpdeskCategoryMutationResponse,
    },
  ),
  "GET /api/v1/helpdesk/sla-report": operation(
    "Helpdesk",
    "Helpdesk SLA report",
    "Returns SLA compliance rows and totals for helpdesk managers, admins, and auditors.",
    {
      querystring: helpdeskQuerySchema,
      response200: {
        ...paginated({ type: "object", additionalProperties: true }),
  ...
  "GET /api/v1/notifications": operation(
    "Notifications",
    "List notifications",
    "Lists authenticated user notifications for the topbar panel with pagination, unread-only, and type/category filtering.",
    {
      querystring: notificationsQuerySchema,
      response200: paginated(notificationSchema),
    },
  ),
  "GET /api/v1/notifications/unread-count": operation(
    "Notifications",
    "Unread notification count",
    "Returns the authenticated user's unread notification count for the topbar badge.",
    {
      response200: {
        type: "object",
        ...
        properties: {
          unread_count: { type: "integer", minimum: 0, example: 2 },
          latest_created_at: dateTime("Latest unread notification timestamp"),
        },
        additionalProperties: false,
      },
    },
  ),
  "POST /api/v1/notifications/{id}/read": operation(
    "Notifications",
    "Mark notification read",
    "Marks one owned notification as read. `expected_version` is optional for topbar interactions but enforces OCC when supplied.",
    {
      params: idParamSchema,
      body: notificationMarkReadBody,
      response200: notificationMarkReadResponse,
    },
  ),
  "POST /api/v1/notifications/read-all": operation(
    "Notifications",
    "Mark all notifications read",
    "Marks all visible unread notifications as read, optionally scoped by type/category or timestamp.",
    { body: notificationReadAllBody, response200: notificationReadAllResponse },
  ),
  "POST /api/v1/attendance/punches": operation(
    ...
    "Records a current punch for the authenticated employee only using the mobile-ready attendance command envelope. The server controls occurrence time; actor, subject, employee ID, company ID, and historical timestamps are not accepted. The body client_event_id must equal the Idempotency-Key header. source=web_geo accepts exactly one browser location result captured at employee action time: coordinates, permission denied, or location unavailable. The server applies geo policy and geofence evaluation; clients must not submit trusted geo decisions, and no continuous or background browser tracking is part of this API. Same-key/same-body retries replay the original business result and emit Idempotency-Replayed: true. Offline retries after the 24-hour platform idempotency window use durable client_event_id command replay and do not create another command, attendance event, location evidence, decision, session mutation, punch, or outbox event. Same UUID with a different command payload returns 409 WORKFLOW_CONFLICT and is a terminal synchronization conflict. Clients must retry network interruptions, timeouts, HTTP 408, HTTP 429 respecting Retry-After, and temporary 5xx with the same UUID and canonical payload; successful responses, replayed responses, persisted business denials, validation failures, workflow/idempotency conflicts, and client-event reuse conflicts are terminal. Replayed responses use the current x-request-id, not the original request ID. Examples: first execution sends a new Idempotency-Key matching client_event_id and receives no Idempotency-Replayed header; immediate identical retry sends the same UUID/payload and receives Idempotency-Replayed: true; offline retry after 24 hours sends the same UUID/payload and receives durable command replay with Idempotency-Replayed: true; different payload for the same UUID receives 409 WORKFLOW_CONFLICT; persisted business-denial replay preserves the denial status and reason with current x-request-id plus Idempotency-Replayed: true.",
    {
      ...
      response: {
        ...
        409: {
          description:
            "Attendance command denied, conflicted, or idempotency-key/body mismatch. Geo denials include details.reason_code, details.geo_policy, and details.next_allowed_actions when applicable.",
          headers: replayResponseHeaders,
          content: {
            "application/json": {
              schema: attendanceBusinessErrorResponseSchema,
            },
          },
        },
      },
  ...
  "POST /api/v1/attendance/offline-sync": operation(
    "Attendance",
    "Sync offline attendance events",
    "Accepts an authenticated mobile offline attendance batch using the Sprint 13 offline sync contract. The server derives company, actor, and employee context, requires a registered mobile device, stores each eligible event provisionally, and returns one sync decision per event. Offline sync does not create punch events, sessions, daily projections, payroll state, or other authoritative live attendance mutations.",
    {
      body: attendanceOfflineBatchEnvelopeSchema,
      response200: attendanceOfflineSyncResponseSchema,
    },
  ),
  ...
  "GET /api/v1/attendance/punches/my": operation(
    ...
    "Lists authenticated employee punch events with date range pagination.",
    {
      ...
      response200: paginated(attendancePunchSchema),
    },
  ),
  "GET /api/v1/attendance/summary/my": operation(
    ...
    {
      querystring: attendanceQuerySchema,
      response200: attendanceSummarySchema,
    },
  ),
  "GET /api/v1/attendance/summary/team": operation(
    ...
    {
      querystring: attendanceQuerySchema,
      response200: attendanceTeamSummarySchema,
    },
  ),
  "GET /api/v1/attendance/calendar/monthly": operation(
    ...
    {
      querystring: attendanceQuerySchema,
      response200: attendanceCalendarSchema,
    },
  ),
  "GET /api/v1/attendance/calendar/daily": operation(
    ...
    {
      querystring: attendanceQuerySchema,
      response200: attendanceDailyCalendarSchema,
    },
  ),
  "POST /api/v1/attendance/regularizations": operation(
    ...
    {
      body: attendanceRegularizationCreateBody,
      response200: attendanceRegularizationSchema,
    },
  ),
  "GET /api/v1/attendance/regularizations/my": operation(
    ...
    {
      querystring: attendanceQuerySchema,
      response200: paginated(attendanceRegularizationSchema),
    },
  ),
  "GET /api/v1/attendance/regularizations/queue/manager": operation(
    ...
    "Lists attendance regularization requests assigned to the authenticated manager, or all in-scope requests for HR/Admin/Auditor monitor views.",
    {
      querystring: attendanceQuerySchema,
      response200: {
        ...paginated(attendanceRegularizationSchema),
        additionalProperties: true,
      },
    },
  ),
  ...
  "GET /api/v1/leave/balances/my": operation(
    ...
    {
      querystring: leaveWfhQuerySchema,
      response200: leaveBalanceResponseSchema,
    },
  ),
  ...
  "GET /api/v1/leave/requests/my": operation(
    ...
    {
      querystring: leaveWfhQuerySchema,
      response200: paginated(leaveRequestSchema),
    },
  ),
  ...
  "GET /api/v1/wfh/requests/my": operation(
    ...
    {
      querystring: leaveWfhQuerySchema,
      response200: paginated(wfhRequestSchema),
    },
  ),
  ...
  "POST /api/v1/ems/profile-change-requests": operation(
    ...
    {
      body: emsProfileChangeCreateBody,
      response200: { type: "object", additionalProperties: true },
    },
  ),
  "GET /api/v1/ems/profile-change-requests/my": operation(
    ...
    {
      querystring: emsQuerySchema,
      response200: paginated(emsProfileChangeSchema),
    },
  ),
  "GET /api/v1/ems/profile-change-requests/queue/hr": operation(
    ...
    "Lists HR/Admin-scoped profile change requests, defaulting to pending requests.",
    {
      querystring: emsQuerySchema,
      response200: {
        ...paginated(emsProfileChangeSchema),
        additionalProperties: true,
      },
    },
  ),
  ...
  "GET /api/v1/ems/requests/my": operation(
    ...
    {
      querystring: emsQuerySchema,
      response200: paginated(emsServiceRequestSchema),
    },
  ),
  "GET /api/v1/ems/requests/queue/hr": operation(
    ...
    "Lists HR/Admin-scoped EMS service requests for operational follow-up.",
    {
      querystring: emsQuerySchema,
      response200: {
        ...paginated(emsServiceRequestSchema),
        additionalProperties: true,
      },
    },
  ),
  "POST /api/v1/ems/requests/{id}/decision": operation(
    ...
    {
      params: idParamSchema,
      body: emsServiceRequestDecisionBody,
      response200: { type: "object", additionalProperties: true },
    },
  ),
  "GET /api/v1/ems/admin/onboarding": operation(
    ...
    {
      querystring: emsQuerySchema,
      response200: paginated(emsAdminChecklistSchema),
    },
  ),
  "PATCH /api/v1/ems/admin/onboarding/{id}": operation(
    ...
    {
      params: idParamSchema,
      body: emsAdminChecklistUpdateBody,
      response200: { type: "object", additionalProperties: true },
    },
  ),
  "GET /api/v1/ems/admin/probation": operation(
    ...
    {
      querystring: emsQuerySchema,
      response200: paginated(emsProbationReviewSchema),
    },
  ),
  ...
  "POST /api/v1/ems/letters/{id}/acknowledge": operation(
    ...
    {
      params: idParamSchema,
      body: expectedVersionBodySchema,
      response200: { type: "object", additionalProperties: true },
    },
  ),
  ...
  "GET /api/v1/ems/employees/{user_id}/documents": operation(
    ...
    {
      params: userIdParamSchema,
      querystring: emsDocumentQuerySchema,
      response200: emsEmployeeDocumentListSchema,
    },
  ),
  ...
  "PUT /api/v1/admin/company-profile": operation(
    ...
    {
      body: adminCompanyProfileUpdateBody,
      response200: adminCompanyProfileSchema,
    },
  ),
  "POST /api/v1/admin/company-profile/logo": operation(
    ...
    {
      body: adminCompanyLogoUploadBodySchema,
      response200: {
        type: "object",
        required: ["company", "document"],
        properties: {
  ...
  "GET /api/v1/admin/master-data/departments": operation(
    ...
    {
      querystring: adminMasterDataQuerySchema,
      response200: paginated(adminDepartmentSchema),
    },
  ),
  ...
  "GET /api/v1/admin/master-data/designations": operation(
    ...
    {
      querystring: adminMasterDataQuerySchema,
      response200: paginated(adminDesignationSchema),
    },
  ),
  "POST /api/v1/admin/master-data/designations": operation(
    ...
    "Creates a designation master row with duplicate-code protection. Admin and HR Manager roles can mutate master data.",
    {
      ...
      response200: {
        ...
        properties: {
          designation: adminDesignationSchema,
          version: { type: "integer", example: 1 },
        },
        additionalProperties: false,
      },
  ...
  "GET /api/v1/admin/master-data/{master_key}": operation(
    ...
    "Lists persistent Admin Settings master-data rows for employment types, work locations, shifts, leave types, expense categories, asset categories, helpdesk categories, and project roles.",
    {
      ...
      querystring: adminMasterDataQuerySchema,
      response200: paginated(adminExtendedMasterDataSchema),
    },
  ),
  "POST /api/v1/admin/master-data/{master_key}": operation(
    ...
    "Creates a persistent row for an Admin Settings master-data group with duplicate-code protection. Admin and HR Manager roles can mutate master data.",
    {
      ...
      response200: {
        ...
        properties: {
          item: adminExtendedMasterDataSchema,
          version: { type: "integer", example: 1 },
        },
        additionalProperties: false,
      },
  ...
  "GET /api/v1/admin/rbac/roles": operation(
    ...
    "Lists persistent RBAC role configuration for Admin Settings. This slice records configuration without changing the existing fixed-role runtime authorization policy.",
    {
      ...
      response200: paginated(adminRbacRoleSchema),
    },
  ),
  ...
  "GET /api/v1/admin/rbac/permissions": operation(
    ...
    "Lists the Admin Settings permission catalog by module/group/action for the RBAC matrix UI.",
    {
      ...
      response200: {
        ...
        required: ["items"],
        properties: {
          items: { type: "array", items: adminRbacPermissionSchema },
        },
        additionalProperties: false,
      },
    },
  ...
  "PUT /api/v1/admin/security-settings": operation(
    ...
    "Persists basic security settings with optimistic concurrency. Password policy, session TTL, and auth rate-limit changes are enforced by backend runtime paths; MFA must remain false until a provider flow is specified.",
    {
      ...
      response200: {
        ...
        properties: {
          settings: adminSecuritySettingsSchema,
          version: { type: "integer", example: 2 },
        },
        additionalProperties: false,
      },
      ...
      body: {
        ...
        properties: {
          primary_finance_manager_user_id: uuid(
            "Configured primary finance manager UUID",
          ),
          manager_backup_user_id: {
            ...uuid("Configured manager backup UUID"),
            nullable: true,
          },
          finance_approval_backup_user_id: {
            ...uuid("Configured finance backup UUID"),
            nullable: true,
          },
  ...
  "POST /api/v1/expenses": operation(
    "Expenses / Requester",
    "Create expense",
    "Creates an expense draft or submitted ticket. Business routing and self-approval prevention remain backend-owned.",
    { body: expenseCreateBody, response200: ticketSchema },
  ),
  "GET /api/v1/expenses/my": operation(
    "Expenses / Requester",
    "My expenses",
    "Lists the authenticated requester's expense tickets.",
    {
      querystring: paginationQuerySchema,
      response200: paginated(ticketSchema),
    },
  ),
  "GET /api/v1/expenses/metadata": operation(
    "Expenses / Requester",
    "Expense metadata",
    "Returns expense form metadata, policy hints, required document selectors, currencies, payment types, and project/client selectors for API-backed expense forms.",
    { response200: expenseMetadataSchema },
  ),
  "GET /api/v1/expenses/dashboard-summary": operation(
    "Expenses / Requester",
    "Expense dashboard summary",
    "Returns role-aware dashboard cards, queue counts, aging buckets, totals, and compact visible rows for the expense dashboard.",
    {
      querystring: expenseDashboardQuery,
      response200: expenseDashboardSummarySchema,
    },
  ),
  "GET /api/v1/expenses/{id}": operation(
    "Expenses / Requester",
    "Expense detail",
    "Reads an expense ticket if the actor has object-level access.",
    { params: idParamSchema, response200: ticketSchema },
  ),
  "PATCH /api/v1/expenses/{id}": operation(
    "Expenses / Requester",
    "Edit expense placeholder",
    "Currently restricted by backend policy and returns a documented business validation error.",
    {
      params: idParamSchema,
      body: { type: "object", additionalProperties: true },
      response: {
        400: {
          description:
            "Edit endpoint is intentionally restricted in this delivery.",
          content: { "application/json": { schema: errorResponseSchema } },
        },
      },
    },
  ),
  "POST /api/v1/expenses/{id}/submit": operation(
    "Expenses / Requester",
    "Submit expense",
    "Submits a draft or returned expense using OCC expected_version.",
    {
      params: idParamSchema,
      body: expectedVersionBodySchema,
      response200: ticketSchema,
    },
  ),
  "POST /api/v1/expenses/{id}/withdraw": operation(
    "Expenses / Requester",
    "Withdraw expense",
    "Withdraws a requester-owned draft, submitted, pending-manager, or manager-returned expense with OCC expected_version. Remarks are required after submission.",
    {
      params: idParamSchema,
      body: expenseWithdrawBody,
      response200: expenseWithdrawResponseSchema,
    },
  ),
  "POST /api/v1/expenses/{id}/clarifications": operation(
    "Expenses / Requester",
    "Add expense clarification",
    "Appends a durable object-scoped clarification message and returns the current thread. Requester, assigned manager, assigned finance actor, Admin, and Auditor can read according to expense object policy.",
    {
      params: idParamSchema,
      body: expenseClarificationBody,
      response200: expenseClarificationResponseSchema,
    },
  ),
  "GET /api/v1/expenses/queue/manager": operation(
    "Expenses / Manager",
    "Manager queue",
    "Lists expense tickets assigned to the authenticated manager or configured manager backup.",
    {
      querystring: paginationQuerySchema,
      response200: paginated(ticketSchema),
    },
  ),
  "POST /api/v1/expenses/{id}/manager/verify": operation(
    "Expenses / Manager",
    "Manager verification decision",
    "Manager approve/reject/return decision. Reject/return require remarks; self-processing and OCC conflicts are enforced.",
    {
      params: idParamSchema,
      body: expenseDecisionBody,
      response200: ticketSchema,
    },
  ),

  "GET /api/v1/expenses/queue/finance": operation(
    "Finance Management",
    "Finance queue",
    "Role-scoped finance operations queue with status, requester, department, date, payment, type/subtype, amount, document, SLA, and sort filters. On finance-manager self-requests, the configured finance backup may see only explicitly routed tickets.",
    {
      querystring: {
        ...paginationQuerySchema,
        properties: {
          ...
          requester: optionalString(
            "Requester employee code or name filter.",
            "E1",
          ),
          department: optionalString(
            "Department code or name filter.",
            "Engineering",
          ),
          ...
          document_status: {
            type: "string",
            enum: ["any", "complete", "missing"],
            default: "any",
          },
          sla_bucket: {
            type: "string",
            enum: ["any", "0-24h", "24-72h", "72h-plus"],
            default: "any",
          },
          sort: {
            type: "string",
            enum: ["sla", "created_at", "amount", "status"],
            default: "sla",
          },
        },
      },
  ...
  "GET /api/v1/expenses/{id}/finance-detail": operation(
    ...
    "Finance-only read model with ticket, line items, documents, payments, approvals, audit, policy warnings, settlement summary, and governance actor assignment metadata.",
    {
      params: idParamSchema,
      response200: { type: "object", additionalProperties: true },
    },
  ),
  "POST /api/v1/expenses/{id}/finance/approve": operation(
    "Finance Management",
    "Finance approve or hold",
    "The assigned finance approver approves, holds, or requests clarification after manager verification. Normally this is the configured primary Finance Manager; for finance-manager self-requests it may be the configured Finance/Admin backup. Hold/clarification require remarks; self-processing and OCC conflicts are enforced.",
    {
      params: idParamSchema,
      body: financeVerifyBody,
      response200: ticketSchema,
    },
  ),
  "POST /api/v1/expenses/{id}/finance/payment": operation(
    "Finance Management",
    "Release payment",
    "The assigned finance-stage actor releases advance or reimbursement payment with date, amount, mode, reference, and OCC expected_version.",
    {
      params: idParamSchema,
      body: paymentReleaseBody,
      response200: ticketSchema,
    },
  ),
  "POST /api/v1/expenses/{id}/bills": operation(
    "Finance Management",
    "Submit bills",
    "Marks bills as submitted for a paid expense. Used before settlement and closure checks.",
    {
      params: idParamSchema,
      body: expectedVersionBodySchema,
      response200: ticketSchema,
  ...
  "POST /api/v1/expenses/{id}/documents/{documentId}/verify": operation(
    "Expenses / Manager",
    "Verify expense document",
    "Assigned manager or manager backup verifies an uploaded expense document. Finance settlement remains blocked until every required document for the expense subtype is verified.",
    { params: expenseDocumentParamSchema, response200: ticketSchema },
  ),
  "POST /api/v1/expenses/{id}/settlement": operation(
    "Finance Management",
    "Approve settlement",
    "Finalizes settlement and calculates payable/recoverable/no-balance state. Required documents must be verified before closure.",
    { params: idParamSchema, body: settlementBody, response200: ticketSchema },
  ),
  "GET /api/v1/expenses/{id}/timeline": operation(
    ...
    {
      params: idParamSchema,
      response200: { type: "array", items: expenseTimelineEventSchema },
    },
  ),
  "GET /api/v1/expenses/{id}/audit": operation(
    "Finance Management",
    "Expense audit log",
    "Immutable expense audit log. Finance/Admin/Auditor and object-scoped actors may read according to backend policy.",
    {
      params: idParamSchema,
      querystring: paginationQuerySchema,
      response200: paginated({ type: "object", additionalProperties: true }),
  ...
  "GET /api/v1/manager-backups": operation(
    "Admin / Configuration",
    "List manager backups",
    "Lists active/effective-dated manager backup assignments.",
    {
      querystring: paginationQuerySchema,
      response200: paginated({ type: "object", additionalProperties: true }),
    },
  ),
  "POST /api/v1/manager-backups": operation(
    "Admin / Configuration",
    "Create manager backup",
    "Creates an effective-dated manager backup assignment. Self mappings and inactive users are blocked.",
    {
      body: {
        type: "object",
        required: [
        ...
        properties: {
          employee_user_id: uuid("Employee user UUID"),
          backup_manager_user_id: uuid("Backup manager user UUID"),
          effective_from: date("Effective from"),
  ...
  "DELETE /api/v1/manager-backups/{id}": operation(
    "Admin / Configuration",
    "Revoke manager backup",
    "Soft-revokes a manager backup assignment. Optional expected_version query supports OCC where available.",
    {
      params: idParamSchema,
      querystring: {
        type: "object",
  ...
  "POST /api/v1/documents": operation(
    "Documents",
    "Upload document metadata",
    "Creates secure document metadata and stores the file through the backend object storage adapter. Object-storage credentials are never exposed.",
    { body: documentUploadBody, response200: documentSchema },
  ),
  "POST /api/v1/expenses/{id}/documents": operation(
    "Documents",
    "Upload expense document",
    "Uploads metadata for an expense ticket document using the path ticket id as business object id.",
    {
      params: idParamSchema,
      body: expenseDocumentUploadBody,
      response200: documentSchema,
    },
  ),
  "GET /api/v1/documents": operation(
    "Documents",
    "List documents",
    "Lists documents visible to the actor with optional business object filters.",
    {
      querystring: {
        ...paginationQuerySchema,
        properties: {
      ...
      response200: paginated(documentSchema),
    },
  ),
  "GET /api/v1/documents/upload-policy": operation(
    "Documents",
    "Get media upload policy",
    "Returns backend-owned media upload limits, allowed MIME types, image compression settings, and Cloudinary transformation used by EMS, expenses, projects, helpdesk, and document uploads.",
    { response200: documentUploadPolicySchema },
  ),
  "GET /api/v1/documents/{id}": operation(
    "Documents",
    "Document metadata",
    "Returns document metadata if classification and object-level access policies allow.",
    { params: idParamSchema, response200: documentSchema },
  ),
  "DELETE /api/v1/documents/{id}": operation(
    "Documents",
    "Delete document",
    "Removes the stored document object and marks the document metadata as deleted after the same write-access policy check. Deleted documents no longer appear in document lists.",
    {
      params: idParamSchema,
      response200: {
        type: "object",
  ...
  "POST /api/v1/documents/{id}/download-url": operation(
    "Documents",
    "Create download URL",
    "Returns a short-lived backend-generated download URL for allowed actors. Does not expose storage credentials.",
    {
      params: idParamSchema,
      response200: {
        type: "object",
        ...
        properties: {
          url: {
            ...
            format: "uri",
            example:
              "http://localhost:3001/api/v1/documents/downloads/local-token",
          },
          expires_at: dateTime("Download URL expiration"),
        },
      },
    },
  ),
  "GET /api/v1/documents/{id}/content": operation(
    "Documents",
    "Download local document content",
    "Streams document bytes through the backend for local/mock object storage after the same document access policy check. Real Cloudinary deployments continue to use provider HTTPS URLs from the download-url endpoint.",
    {
      params: idParamSchema,
      response200: { type: "string", format: "binary" },
    },
  ),
  "POST /api/v1/documents/{id}/verify": operation(
    "Documents",
    "Verify document",
    "Marks a document as verified when actor has Finance/HR/Admin classification authority.",
    { params: idParamSchema, response200: documentSchema },
  ),
  "GET /api/v1/documents/{id}/access-log": operation(
    "Documents",
    "Document access log",
    "Paginated immutable document access log for auditors/admins.",
    {
      params: idParamSchema,
      querystring: paginationQuerySchema,
      response200: paginated({ type: "object", additionalProperties: true }),
  ...
  "GET /api/v1/reports/expenses/my": operation(
    "Reports & Analytics",
    "My expense report",
    "Paginated requester-owned expense report with filters, dashboard cards, totals, document summary, payment summary, and workflow action hints for compact frontend list/cards.",
    {
      querystring: expenseReportQuerySchema,
      response200: expenseReportListSchema,
    },
  ),
  "GET /api/v1/reports/expenses/manager-queue": operation(
    "Reports & Analytics",
    "Manager queue report",
    "Manager-scoped queue report with direct/backup assignment counts, aging, amount cards, missing-document indicators, and manager_action_required flags.",
    {
      querystring: expenseReportQuerySchema,
      response200: managerQueueReportSchema,
    },
  ),
  "GET /api/v1/reports/expenses/manager-history": operation(
    "Reports & Analytics",
    "Manager action history",
    "Manager-scoped history of verified, returned, and rejected requests with remarks, deciding actor, previous/next status, and audit route metadata.",
    { querystring: expenseReportQuerySchema, response200: historyReportSchema },
  ),
  "GET /api/v1/reports/expenses/finance-dashboard": operation(
    "Finance Management",
    "Finance dashboard dataset",
    "Finance dashboard dataset with cards, aging buckets, payable/recoverable totals, exception counts, document risks, and compact ticket rows.",
    {
      querystring: expenseReportQuerySchema,
      response200: financeDashboardReportSchema,
    },
  ),
  "GET /api/v1/reports/expenses/finance-history": operation(
    "Finance Management",
    "Finance action history",
    "Finance history of approval, hold, payment, and settlement actions with actor labels, payment metadata, remarks, and audit event information.",
    { querystring: expenseReportQuerySchema, response200: historyReportSchema },
  ),
  "GET /api/v1/reports/expenses/finance-analytics": operation(
    "Finance Management",
    "Finance analytics",
    "Finance cockpit analytics: cards, aging buckets, payable totals, exception counts, status distribution, spend trend, department/type spend, settlement variance, policy risks, and high-value watchlists.",
    { response200: financeAnalyticsSchema },
  ),
  "GET /api/v1/reports/expenses/register": operation(
    "Reports & Analytics",
    "Expense register",
    "Role-scoped expense register with accounting columns, totals, export column hints, document status, payment reference, settlement delta, filters, and compact rows.",
    {
      querystring: expenseReportQuerySchema,
      response200: registerReportSchema,
    },
  ),
  "GET /api/v1/reports/expenses/advance-aging": operation(
    "Finance Management",
    "Advance aging report",
    "Finance report of open advances awaiting bills, settlement, adjustment, or closure.",
    {
      querystring: paginationQuerySchema,
      response200: paginated(ticketSchema),
    },
  ),
  "GET /api/v1/reports/expenses/payments": operation(
    "Finance Management",
    "Payment register",
    "Finance payment release register with ticket context.",
    {
      querystring: paginationQuerySchema,
      response200: paginated({ type: "object", additionalProperties: true }),
    },
  ),
  "GET /api/v1/reports/expenses/audit": operation(
    "Finance Management",
    "Finance audit report",
    "Read-only audit report for Finance/Auditor/Admin roles.",
    {
      querystring: paginationQuerySchema,
      response200: paginated({ type: "object", additionalProperties: true }),
    },
  ),
  "GET /api/v1/reports/hr/employees": operation(
    "Reports & Analytics",
    "HR employee report",
    "HR/Admin/Auditor employee master report with headcount, department/designation breakdowns, role access rows, and filters.",
    {
      querystring: reportSummaryQuerySchema,
      response200: genericReportSummarySchema,
    },
  ),
  "GET /api/v1/reports/attendance/summary": operation(
    "Reports & Analytics",
    "Attendance report",
    "Attendance report rows for daily status, work hours, late/early exceptions, and department/status rollups.",
    {
      querystring: reportSummaryQuerySchema,
      response200: genericReportSummarySchema,
    },
  ),
  "GET /api/v1/reports/leave-wfh/summary": operation(
    "Reports & Analytics",
    "Leave and WFH report",
    "Leave/WFH report rows with balances, holidays, request status breakdowns, and duration totals.",
    {
      querystring: reportSummaryQuerySchema,
      response200: genericReportSummarySchema,
    },
  ),
  "GET /api/v1/reports/projects/summary": operation(
    "Reports & Analytics",
    "Project portfolio report",
    "Project report rows with allocations, utilization, assignment history, and cost rollups.",
    {
      querystring: reportSummaryQuerySchema,
      response200: genericReportSummarySchema,
    },
  ),
  "GET /api/v1/reports/timesheets/summary": operation(
    "Reports & Analytics",
    "Timesheet report",
    "Timesheet report rows with submitted hours, billable mix, project rollups, and productivity rows.",
    {
      querystring: reportSummaryQuerySchema,
      response200: genericReportSummarySchema,
    },
  ),
  "GET /api/v1/reports/assets/summary": operation(
    "Reports & Analytics",
    "Asset report",
    "Asset report rows with inventory status, maintenance history, recovery queue, and type/status breakdowns.",
    {
      querystring: reportSummaryQuerySchema,
      response200: genericReportSummarySchema,
    },
  ),
  "GET /api/v1/reports/helpdesk/summary": operation(
    "Reports & Analytics",
    "Helpdesk report",
    "Helpdesk report rows with open/closed/SLA rollups, agent performance, category, employee, and resolution rows.",
    {
      querystring: reportSummaryQuerySchema,
      response200: genericReportSummarySchema,
    },
  ),
  "GET /api/v1/reports/audit": operation(
    "Reports & Analytics",
    "Cross-module audit report",
    "Admin/Auditor cross-module audit report assembled from expense audit logs, outbox events, asset events, and helpdesk events.",
    {
      querystring: reportSummaryQuerySchema,
      response200: genericReportSummarySchema,
    },
  ),
  "GET /api/v1/reports/exports": operation(
    "Reports & Analytics",
    "List export jobs",
    "Lists report export jobs backed by durable outbox events. Admin/Auditor can see all; other users see their own jobs.",
    {
      querystring: reportSummaryQuerySchema,
      response200: paginated(reportExportJobSchema),
    },
  ),
  "GET /api/v1/reports/exports/{id}": operation(
    "Reports & Analytics",
    "Get export job",
    "Returns one report export job and generated document reference when available.",
    { params: idParamSchema, response200: reportExportJobSchema },
  ),
  "POST /api/v1/reports/exports": operation(
    "Reports & Analytics",
    "Create export job",
    "Creates a CSV or XLSX report export document backed by object storage and durable outbox metadata.",
    { body: reportExportCreateBodySchema, response200: reportExportJobSchema },
  ),

  "POST /api/v1/assets/": operation(
    "Assets",
    "Create asset",
    "Creates an asset inventory record. Asset/Admin role required.",
    {
      body: {
        type: "object",
        required: ["asset_code", "asset_type", "name"],
        properties: {
          asset_code: { type: "string", example: "LAP-001" },
          asset_type: { type: "string", example: "Laptop" },
          name: { type: "string", example: "ThinkPad T-Series" },
      ...
      response200: assetSchema,
    },
  ),
  "GET /api/v1/assets/": operation(
    "Assets",
    "List assets",
    "Paginated asset inventory list.",
    { querystring: paginationQuerySchema, response200: paginated(assetSchema) },
  ),
  "GET /api/v1/assets/{id}": operation(
    "Assets",
    "Asset detail",
    "Returns full asset details for Asset/Admin actors.",
    { params: idParamSchema, response200: assetSchema },
  ),
  "POST /api/v1/assets/{id}/assign": operation(
    "Assets",
    "Assign asset",
    "Assigns an asset to an employee with OCC expected_version.",
    {
      params: idParamSchema,
      body: {
        type: "object",
        required: ["assigned_to_user_id", "expected_version"],
        properties: {
          assigned_to_user_id: uuid("Employee user UUID"),
          expected_version: { type: "integer", minimum: 1, example: 1 },
        },
      },
      response200: assetSchema,
  ...
  "POST /api/v1/assets/{id}/return": operation(
    "Assets",
    "Return asset",
    "Returns/recover an asset with OCC expected_version.",
    {
      params: idParamSchema,
      body: expectedVersionBodySchema,
      response200: assetSchema,
  ...
  "POST /api/v1/assets/scan/{qr_hash}": operation(
    "Assets",
    "Safe QR scan",
    "Public-safe QR/hash lookup that intentionally omits internal IDs, cost, and sensitive metadata.",
    {
      params: qrHashParamSchema,
      response200: {
        type: "object",
        required: [
          "qr_hash",
        ...
        properties: {
          ...
          name: { type: "string", example: "ThinkPad T-Series" },
          status: { type: "string", example: "In Stock" },
          assigned: { type: "string", example: "unassigned" },
        },
      },
    },
    false,
  ),
  "POST /api/v1/assets/licenses/activate": operation(
    "Assets",
    "Activate license",
    "Activates a software license entitlement for a hardware fingerprint.",
    {
      body: {
        type: "object",
        required: ["product_id", "entitlement_id", "hardware_fingerprint"],
        properties: {
          product_id: uuid("Software product UUID"),
          entitlement_id: uuid("Entitlement UUID"),
          hardware_fingerprint: {
            type: "string",
            minLength: 8,
            example: "HW-FINGERPRINT-001",
          },
        },
      },
      response200: { type: "object", additionalProperties: true },
  ...
  "POST /api/v1/assets/licenses/validate": operation(
    "Assets",
    "Validate license",
    "Validates software license binding for a hardware fingerprint.",
    {
      body: {
        type: "object",
        required: ["product_id", "hardware_fingerprint"],
        properties: {
          product_id: uuid("Software product UUID"),
          hardware_fingerprint: {
            type: "string",
  ...
  "POST /api/v1/assets/licenses/revoke": operation(
    ...
    "Revokes a hardware fingerprint or compromised key/device binding.",
    {
      body: {
        type: "object",
  ...
  "POST /api/v1/assets/events/employee-terminated": operation(
    ...
    "Consume employee terminated event",
    "Protected local event consumer that moves assigned assets into recovery workflow when an employee is terminated.",
    {
      body: {
        type: "object",
        required: ["employee_user_id"],
        properties: { employee_user_id: uuid("Terminated employee UUID") },
      },
      response200: { type: "object", additionalProperties: true },
    },
  ),
  "GET /api/v1/assets/warranty-alerts": operation(
    "Assets",
    "Asset warranty alerts",
    "Lists expired and soon-expiring asset warranties using the Admin asset policy warranty alert window unless a narrower window is requested.",
    {
      querystring: assetWarrantyAlertsQuerySchema,
      response200: {
        ...paginated(assetWarrantyAlertSchema),
        required: [
          "items",
          "page",
          "page_size",
        ...
        properties: {
          ...paginated(assetWarrantyAlertSchema).properties,
          alert_window_days: { type: "integer", example: 60 },
          generated_at: dateTime("Generation timestamp"),
          counts: {
            type: "object",
            required: ["expired", "critical", "warning"],
            properties: {
  ...
  "POST /api/v1/assets/requests": operation(
    "Assets",
    "Create asset request",
    "Creates an authenticated employee asset request for new, replacement, repair, or return needs.",
    {
      body: assetRequestBodySchema,
      response200: {
        type: "object",
        required: ["request", "version"],
        properties: {
  ...
  "GET /api/v1/assets/requests/my": operation(
    "Assets",
    "List my asset requests",
    "Lists asset requests raised by the authenticated employee.",
    {
      querystring: paginationQuerySchema,
      response200: paginated(assetRequestSchema),
    },
  ),
  "GET /api/v1/assets/requests/queue": operation(
    "Assets",
    "Asset request queue",
    "Lists asset requests for Asset/Admin actors with queue counts.",
    {
      querystring: paginationQuerySchema,
      response200: {
        ...paginated(assetRequestSchema),
        additionalProperties: true,
      },
    },
  ),
  "POST /api/v1/assets/requests/{id}/decision": operation(
    "Assets",
    "Decide asset request",
    "Approves, rejects, returns, or fulfills an asset request with OCC expected_version.",
    {
      params: idParamSchema,
      body: assetRequestDecisionBodySchema,
      response200: {
        type: "object",
        required: ["request", "version"],
        properties: {
          request: assetRequestSchema,
          assigned_asset: { ...assetSchema, nullable: true },
          version: { type: "integer", minimum: 1, example: 2 },
        },
        additionalProperties: true,
      },
  ...
  "POST /api/v1/assets/requests/{id}/cancel": operation(
    "Assets",
    "Cancel asset request",
    "Cancels a requester-owned pending asset request with OCC expected_version.",
    {
      params: idParamSchema,
      body: expectedVersionBodySchema,
      response200: {
  ...
  "POST /api/v1/assets/{id}/acknowledgements": operation(
    "Assets",
    "Acknowledge asset handover",
    "Marks an assigned asset as received or returned by the assigned employee.",
    {
      params: idParamSchema,
      body: {
        type: "object",
        required: ["acknowledgement_type", "expected_version"],
        properties: {
      ...
      response200: {
        type: "object",
        required: ["asset", "acknowledgement", "version"],
        properties: {
          asset: assetSchema,
  ...
  "GET /api/v1/assets/{id}/maintenance": operation(
    "Assets",
    ...
    "Lists maintenance records for an asset.",
    {
      params: idParamSchema,
      querystring: paginationQuerySchema,
      response200: paginated(assetMaintenanceSchema),
    },
  ),
  "POST /api/v1/assets/{id}/maintenance": operation(
    "Assets",
    "Create asset maintenance",
    "Creates a maintenance, warranty, repair, or inspection record and updates asset state with OCC expected_version.",
    {
      params: idParamSchema,
      body: {
        type: "object",
        required: ["maintenance_type", "started_on", "expected_version"],
        properties: {
          maintenance_type: {
            type: "string",
            enum: ["repair", "preventive", "warranty", "inspection", "other"],
      ...
      response200: {
        type: "object",
        required: ["maintenance", "asset", "asset_version"],
        properties: {
          maintenance: assetMaintenanceSchema,
          asset: assetSchema,
          asset_version: { type: "integer", minimum: 1, example: 2 },
        },
        additionalProperties: false,
      },
    },
  ),
  "GET /api/v1/assets/vendors": operation(
    "Assets",
    "List asset vendors",
    "Lists asset vendors, warranty partners, and selector metadata for asset workflows.",
    {
      querystring: paginationQuerySchema,
      response200: paginated(assetVendorSchema),
    },
  ),
  "POST /api/v1/assets/vendors": operation(
    "Assets",
    "Create asset vendor",
    "Creates a vendor or warranty partner used by maintenance and warranty workflows. Asset/Admin role required.",
    {
      body: assetVendorCreateBodySchema,
      response200: {
        type: "object",
        required: ["vendor", "version"],
        properties: {
          vendor: assetVendorSchema,
          version: { type: "integer", minimum: 1, example: 1 },
        },
        additionalProperties: false,
      },
  ...
  "PATCH /api/v1/assets/vendors/{id}": operation(
    "Assets",
    "Update asset vendor",
    "Updates vendor contact/status details with OCC expected_version. Asset/Admin role required.",
    {
      params: idParamSchema,
      body: assetVendorUpdateBodySchema,
      response200: {
        type: "object",
        required: ["vendor", "version"],
        properties: {
  ...
  "GET /api/v1/assets/recovery-queue": operation(
    "Assets",
    "Asset recovery queue",
    "Lists assets pending recovery from offboarding or termination events.",
    {
      querystring: paginationQuerySchema,
      response200: {
        ...paginated(assetRecoveryTicketSchema),
        additionalProperties: true,
      },
    },
  ),
  "POST /api/v1/assets/recovery-queue/{id}/settlement": operation(
    "Assets",
    "Settle asset recovery ticket",
    "Closes an offboarding asset recovery ticket, updates the linked asset status, and records recovery settlement details with OCC expected_version.",
    {
      params: idParamSchema,
      body: assetRecoverySettlementBodySchema,
      response200: {
        type: "object",
        required: ["ticket", "asset", "version"],
        properties: {
          ticket: assetRecoveryTicketSchema,
          asset: assetSchema,
          version: { type: "integer", minimum: 1, example: 2 },
        },
        additionalProperties: false,
  ...
  "POST /api/v1/timesheets/work-segments": operation(
    "Timesheets",
    "Create work segment",
    "Creates or updates a daily work segment for the authenticated employee.",
    {
      body: {
        type: "object",
        required: ["work_date", "hours"],
        properties: {
          work_date: date("Work date", "2026-06-01"),
          project_code: { type: "string", example: "QA-PRJ-001" },
          task_code: { type: "string", example: "QA-TASK-001" },
          hours: money("Hours as fixed precision decimal", "8.00"),
          description: { type: "string", example: "Implementation work" },
          billable: { type: "boolean", default: false, example: true },
        },
      },
      response200: { type: "object", additionalProperties: true },
    },
  ),
  "GET /api/v1/timesheets/work-segments": operation(
    "Timesheets",
    "List work segments",
    "Paginated work segment list scoped by actor.",
    {
      querystring: paginationQuerySchema,
      response200: paginated({ type: "object", additionalProperties: true }),
    },
  ),
  "POST /api/v1/timesheets/submissions": operation(
    "Timesheets",
    "Submit timesheet cycle",
    "Submits a timesheet cycle for approval.",
    {
      body: {
        type: "object",
        required: ["cycle_start", "cycle_end"],
        properties: {
          cycle_start: date("Cycle start", "2026-06-01"),
          cycle_end: date("Cycle end", "2026-06-07"),
        },
      },
      response200: { type: "object", additionalProperties: true },
    },
  ),
  "GET /api/v1/timesheets/submissions/my": operation(
    "Timesheets",
    "My timesheet submissions",
    "Lists authenticated employee timesheet submissions.",
    {
      querystring: paginationQuerySchema,
      response200: paginated({ type: "object", additionalProperties: true }),
    },
  ),
  "GET /api/v1/timesheets/queue/approver": operation(
    "Timesheets",
    "Approver queue",
    "Timesheet approval queue for the authenticated approver with compact project/member metadata, cycle hours, expected-hours context, decision history, and admin override visibility. Omit status for active pending approvals; Admin can use status to inspect returned/rejected history.",
    {
      querystring: timesheetApproverQueueQuerySchema,
      response200: timesheetApproverQueueResponseSchema,
    },
  ),
  "GET /api/v1/timesheets/projects/summary": operation(
    "Timesheets",
    "Project timesheet summary",
    "Returns project-level timesheet rollups, member submitted/missing state, billable split, and cycle totals for the actor's visible project scope.",
    {
      querystring: timesheetAnalyticsQuerySchema,
      response200: timesheetProjectSummaryResponseSchema,
    },
  ),
  "GET /api/v1/timesheets/missing-submissions": operation(
    "Timesheets",
    "Missing timesheet submissions",
    "Returns visible employees with missing or under-submitted timesheet cycles, including manager and reminder context.",
    {
      querystring: timesheetAnalyticsQuerySchema,
      response200: timesheetMissingSubmissionsResponseSchema,
    },
  ),
  "GET /api/v1/timesheets/productivity-summary": operation(
    "Timesheets",
    "Timesheet productivity summary",
    "Returns backend-derived productivity cards, time series, and breakdown rows grouped by employee, project, department, or week.",
    {
      querystring: timesheetAnalyticsQuerySchema,
      response200: timesheetProductivitySummaryResponseSchema,
    },
  ),
  "GET /api/v1/timesheets/selectors": operation(
    "Timesheets",
    "Timesheet selectors",
    "Returns visible projects, task selectors, cycles, approvers, workflow definitions, and rules for timesheet forms.",
    {
      querystring: timesheetSelectorsQuerySchema,
      response200: timesheetSelectorsResponseSchema,
    },
  ),
  "GET /api/v1/timesheets/submissions/{id}": operation(
    "Timesheets",
    "Timesheet submission detail",
    "Returns one visible submission with segments, project/member/hour metadata, workflow history, and latest decision.",
    {
      params: idParamSchema,
      response200: timesheetSubmissionDetailResponseSchema,
    },
  ),
  "POST /api/v1/timesheets/submissions/{id}/approve": operation(
    "Timesheets",
    "Timesheet decision",
    "Approves, rejects, or returns a timesheet submission with OCC expected_version. Reject/return require remarks. The response preserves top-level submission fields and adds previous_status, next_status, audit_event, workflow_history, member/project/hour metadata, and allowed next actions.",
    {
      params: idParamSchema,
      body: {
        type: "object",
        ...
        properties: {
          ...
          remarks: {
            type: "string",
            description:
              "Required for reject/return decisions. Trimmed before storage.",
            example: "Approved.",
          },
          expected_version: { type: "integer", minimum: 1, example: 1 },
        },
      },
      response200: timesheetDecisionResponseSchema,
    },
  ),
  "GET /api/v1/timesheets/workflow-definitions": operation(
    "Timesheets",
    "List workflow definitions",
    "Lists timesheet workflow definitions.",
    {
      querystring: paginationQuerySchema,
      response200: paginated({ type: "object", additionalProperties: true }),
    },
  ),
  "POST /api/v1/timesheets/workflow-definitions": operation(
    "Admin / Configuration",
    "Upsert workflow definition",
    "Creates or updates a timesheet workflow definition. Admin role required by backend policy.",
    {
      body: {
        type: "object",
        required: ["name", "definition"],
        properties: {
          name: { type: "string", example: "Default Manager Approval" },
          definition: {
            type: "object",
            required: ["approver_strategy"],
            properties: {
              approver_strategy: {
                type: "string",
                enum: ["ltree_manager", "project_manager", "hr_manager"],
                example: "ltree_manager",
              },
              require_billable_review: { type: "boolean", default: false },
            },
          },
        },
      },
...
export const openApiTags = [
  {
    ...
    description: "Liveness, readiness, and OpenAPI contract endpoints.",
  },
  {
    name: "Platform / Devices",
    description:
      "Authenticated mobile device registration and owner-scoped listing.",
  },
  {
    name: "Auth & Sessions",
    description: "Login, logout, and current session context.",
  },
  {
    name: "Core / Employees & Hierarchy",
    description: "Core employee identity and ltree hierarchy lookup.",
  },
  {
    name: "Dashboard",
    description:
      "Role-scoped dashboard summaries derived from implemented backend modules.",
  },
  {
    name: "Expenses / Requester",
    description: "Requester-owned expense creation and read flows.",
  },
  {
    name: "Expenses / Manager",
    description:
      "Manager verification queue, document checks, and decision workflow.",
  },
  {
    name: "Finance Management",
    description:
      "Finance queue, approval, payment, settlement, analytics, audit, and finance reports.",
  },
  {
    name: "Documents",
    description:
      "Secure document metadata, object-storage-backed file access, verification, and access logs.",
  },
  {
    name: "Assets",
    description:
      "Asset inventory, QR scan, assignment, recovery, and license workflows.",
  },
  {
    name: "Timesheets",
    description:
      "Work segments, submissions, approval queues, and workflow definitions.",
  },
  {
    name: "Attendance",
    description:
      "Punches, summaries, calendars, exceptions, and regularization workflows.",
  },
  {
    name: "Leave / WFH / Holidays",
    description:
      "Leave balances, leave/WFH request workflows, HR monitor, and holiday calendar contracts.",
  },
  {
    name: "EMS",
    description:
      "Employee self-service profile, requests, HR letters, and policy acknowledgement workflows.",
  },
  {
    name: "Projects / Utilization",
    description:
      "Project CRUD, delivery team allocation, milestones, project summaries, and utilization analytics.",
  },
  {
    name: "Helpdesk",
    description:
      "Ticket creation, support queue, comments, attachments, assignment, SLA tracking, and ticket lifecycle workflow.",
  },
  {
    name: "Reports & Analytics",
    description: "Role-scoped expense registers and export readiness.",
  },
  {
    name: "Notifications",
    description:
      "User notification feed, unread badge count, and read-state mutations.",
  },
  {
    name: "Outbox / Platform Events",
    description:
      "Transactional outbox and protected local event consumer contracts.",
  },
  {
...
export const openApiComponents = {
  securitySchemes: {
    ...
    sessionCookie: {
      ...
      name: "hrms_session",
      description:
        "HttpOnly session cookie set by login. Actual cookie name is environment-configured.",
    },
  },
  schemas: {
    ...
    AttendanceGeoEvaluation:
      attendanceGeoPolicySnapshotSchema.properties.evaluation,
    ...
    AttendanceRegularizationItem: (
      attendanceRegularizationCreateBody.properties.items as RouteSchema
    ).items,
    ...
    AttendanceGeofencePublishedVersion:
      attendanceGeofencePublishedVersionSchema,
...
export const swaggerTransform: NonNullable<
...
export const swaggerTransformObject = ((
  documentObject: SwaggerTransformObjectInput,
) => {
